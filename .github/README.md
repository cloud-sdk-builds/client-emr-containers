...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fzeXm7fkMhGYr6QIa41D7OxJ9pcxZCT8/Xrp1nc1PMheAi9GZFovpJTixAQSCGzJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.699.0/index.min.mjs": "sha384-fzeXm7fkMhGYr6QIa41D7OxJ9pcxZCT8/Xrp1nc1PMheAi9GZFovpJTixAQSCGzJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.699.0/LICENSE
```

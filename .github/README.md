...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.896.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.896.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dYdiIqKrxdt3Q/d7LngP0PwsD88js2x2UPy6pXeyUV16Fwp1mTg26105yEFsmk/u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.896.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.896.0/index.min.mjs": "sha384-dYdiIqKrxdt3Q/d7LngP0PwsD88js2x2UPy6pXeyUV16Fwp1mTg26105yEFsmk/u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.896.0/LICENSE
```

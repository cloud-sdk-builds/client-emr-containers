...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.181.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.181.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Kwc0KkErjfRuNoKPbo5fNl0gga8+DeOwQERaaqfCX+rtYIEnpmFfh9ahVxsfL7oJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.181.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.181.0/index.min.mjs": "sha384-Kwc0KkErjfRuNoKPbo5fNl0gga8+DeOwQERaaqfCX+rtYIEnpmFfh9ahVxsfL7oJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.181.0/LICENSE
```

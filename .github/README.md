...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1fj7N+2wcmKjVVhCdcphsDDR32jTGBZhrgwBEc4F28PPxK1UEJOyY8kdt/5TPq2X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.387.0/index.min.mjs": "sha384-1fj7N+2wcmKjVVhCdcphsDDR32jTGBZhrgwBEc4F28PPxK1UEJOyY8kdt/5TPq2X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.387.0/LICENSE
```

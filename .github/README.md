...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XkRF/IFB/We9utR3GyZjZ6BEhqSsUINXXBse4ENYRUSEucwkwX3w0AVnSMRbD+a5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.932.0/index.min.mjs": "sha384-XkRF/IFB/We9utR3GyZjZ6BEhqSsUINXXBse4ENYRUSEucwkwX3w0AVnSMRbD+a5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.932.0/LICENSE
```

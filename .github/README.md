...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.477.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.477.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gScX2v2MEVv0BppgK1nJjNyA/z7q7fCWL5Ja9tHIH63/QBqCnfGMYASEKxKLqqn1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.477.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.477.0/index.min.mjs": "sha384-gScX2v2MEVv0BppgK1nJjNyA/z7q7fCWL5Ja9tHIH63/QBqCnfGMYASEKxKLqqn1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.477.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.835.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.835.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cMW6Wp7NW8QOdohO3Eke8odSqNR5nc7341wFqhrljWPNlyMwr8m32EI7sXY0VzJ5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.835.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.835.0/index.min.mjs": "sha384-cMW6Wp7NW8QOdohO3Eke8odSqNR5nc7341wFqhrljWPNlyMwr8m32EI7sXY0VzJ5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.835.0/LICENSE
```

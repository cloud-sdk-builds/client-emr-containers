...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.450.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.450.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5r7XnJmLRjrxdEdPyV4fHXqNLhfxbPGAPo/Rldt9NE+wdD9oIwe8H3lKHO+oz/gD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.450.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.450.0/index.min.mjs": "sha384-5r7XnJmLRjrxdEdPyV4fHXqNLhfxbPGAPo/Rldt9NE+wdD9oIwe8H3lKHO+oz/gD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.450.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.338.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.338.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JP2xZTOQvKxxK16O1bpRdD/hmrPdWw/YOb/gtef9mWn9EJNjrMlFQaLKyCX1P4H3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.338.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.338.0/index.min.mjs": "sha384-JP2xZTOQvKxxK16O1bpRdD/hmrPdWw/YOb/gtef9mWn9EJNjrMlFQaLKyCX1P4H3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.338.0/LICENSE
```

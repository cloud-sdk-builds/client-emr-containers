...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.670.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.670.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-00Al8EFpNFxVK8P1AB/E6ddhjqt0R5z2N9Adn3f1o2+1qRJ0jOMss750Qt7NdVMA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.670.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.670.0/index.min.mjs": "sha384-00Al8EFpNFxVK8P1AB/E6ddhjqt0R5z2N9Adn3f1o2+1qRJ0jOMss750Qt7NdVMA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.670.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t4zIYRBKYDX/tZPoVrXIDhjy/y6wSaC1nt1ANpWvzvUNSejDFF/brOIwh3Vto5+V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.94.0/index.min.mjs": "sha384-t4zIYRBKYDX/tZPoVrXIDhjy/y6wSaC1nt1ANpWvzvUNSejDFF/brOIwh3Vto5+V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.94.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aHdJr0xyC+8ZXCR3I3RA3WgKNWCMyoFR++zEc/xReFLZ3tUpBECrq40uoNriO57c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.241.0/index.min.mjs": "sha384-aHdJr0xyC+8ZXCR3I3RA3WgKNWCMyoFR++zEc/xReFLZ3tUpBECrq40uoNriO57c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.241.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.42.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.42.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0f0KB1WTvl050tIqth7VujLT8vajSKGs2Q/lugqggQW6plmi1BaLttTvOoR6Dp7G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.42.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.42.0/index.min.mjs": "sha384-0f0KB1WTvl050tIqth7VujLT8vajSKGs2Q/lugqggQW6plmi1BaLttTvOoR6Dp7G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.42.0/LICENSE
```

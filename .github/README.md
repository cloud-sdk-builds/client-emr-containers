...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YAUWfFYRGT//rDuKh2sxFFyoFLd+aPqFKstWy2ySCMcl9BMsbgpGeNh+B96nuGH3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.966.0/index.min.mjs": "sha384-YAUWfFYRGT//rDuKh2sxFFyoFLd+aPqFKstWy2ySCMcl9BMsbgpGeNh+B96nuGH3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.966.0/LICENSE
```

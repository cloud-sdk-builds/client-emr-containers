...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.211.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.211.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UvhFOPCb+Bvk35aMEgKpZKl0hSaED8UH7IfEuFfU7sMxylIlyf41a4T96/gTUWg5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.211.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.211.0/index.min.mjs": "sha384-UvhFOPCb+Bvk35aMEgKpZKl0hSaED8UH7IfEuFfU7sMxylIlyf41a4T96/gTUWg5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.211.0/LICENSE
```

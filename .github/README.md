...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.312.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.312.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kyaCWSGr7uZ5yLFz0B4i3inM/ojJUf06MAFxR76He14JyGqovK+38Za9CCKLyphV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.312.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.312.0/index.min.mjs": "sha384-kyaCWSGr7uZ5yLFz0B4i3inM/ojJUf06MAFxR76He14JyGqovK+38Za9CCKLyphV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.312.0/LICENSE
```

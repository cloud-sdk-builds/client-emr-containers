...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.568.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.568.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GW1A7+3n4u66pDHN4Q2YfZzXhIO029HSDup/81bIndQpju3Iqjhm37zi2+eZ7Ok8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.568.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.568.0/index.min.mjs": "sha384-GW1A7+3n4u66pDHN4Q2YfZzXhIO029HSDup/81bIndQpju3Iqjhm37zi2+eZ7Ok8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.568.0/LICENSE
```

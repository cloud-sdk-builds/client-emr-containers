...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.686.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.686.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZBAJgpNnwVKxJyxOxu3G6mni8/F6QzcgFnDcuiGeh3G/Bsf+XgegjPV75N0DFY5I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.686.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.686.0/index.min.mjs": "sha384-ZBAJgpNnwVKxJyxOxu3G6mni8/F6QzcgFnDcuiGeh3G/Bsf+XgegjPV75N0DFY5I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.686.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.223.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.223.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c/d4UGvoB8SY9yF/NVVBGTt84zGPwJ533F97ukcPqHJUkkHnCcY5NcDBclobr8Dy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.223.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.223.0/index.min.mjs": "sha384-c/d4UGvoB8SY9yF/NVVBGTt84zGPwJ533F97ukcPqHJUkkHnCcY5NcDBclobr8Dy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.223.0/LICENSE
```

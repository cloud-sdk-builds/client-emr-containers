...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2G5VwBnVLe0+lC2vusXypRQ62bIBumFuTEV0qhzmkCWsNiNn+ZVNkPDVRox4L4UG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.985.0/index.min.mjs": "sha384-2G5VwBnVLe0+lC2vusXypRQ62bIBumFuTEV0qhzmkCWsNiNn+ZVNkPDVRox4L4UG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.985.0/LICENSE
```

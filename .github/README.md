...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.935.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.935.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oxLmWGzPRr1VOF+t1eY72hDN+1Xog0cbz7Op8dq0cmQO4QkhTqNkpz6OkKXsp+cT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.935.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.935.0/index.min.mjs": "sha384-oxLmWGzPRr1VOF+t1eY72hDN+1Xog0cbz7Op8dq0cmQO4QkhTqNkpz6OkKXsp+cT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.935.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.271.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.271.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AfwAtIFdoZ+UgEubXS3USiZG/TKFgElh4q3WjvuiYcoCw0KYDXo8qaMyYwuNOQ+x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.271.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.271.0/index.min.mjs": "sha384-AfwAtIFdoZ+UgEubXS3USiZG/TKFgElh4q3WjvuiYcoCw0KYDXo8qaMyYwuNOQ+x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.271.0/LICENSE
```

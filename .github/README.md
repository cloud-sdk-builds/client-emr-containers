...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cOujsni5inNTw91faIR65NMa7nyPqgEU8SEaeQe/76oOW+pLzcDavqyW+7ldLqyi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.709.0/index.min.mjs": "sha384-cOujsni5inNTw91faIR65NMa7nyPqgEU8SEaeQe/76oOW+pLzcDavqyW+7ldLqyi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.709.0/LICENSE
```

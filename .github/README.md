...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1015.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1015.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LLjgfh0rVZZZ67d0liXB8rSi5CGSFzwNqGQLN1o0BGNBEcBPagZJprKb4dQDLz1B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1015.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1015.0/index.min.mjs": "sha384-LLjgfh0rVZZZ67d0liXB8rSi5CGSFzwNqGQLN1o0BGNBEcBPagZJprKb4dQDLz1B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1015.0/LICENSE
```

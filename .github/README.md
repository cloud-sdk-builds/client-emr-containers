...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.266.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.266.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GA8iNYN+FvCZHcItFPe9GAqcRBTUj/eES9tyBGdrd64kbmqRfxe4fWixzkxbt1ut
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.266.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.266.0/index.min.mjs": "sha384-GA8iNYN+FvCZHcItFPe9GAqcRBTUj/eES9tyBGdrd64kbmqRfxe4fWixzkxbt1ut"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.266.0/LICENSE
```

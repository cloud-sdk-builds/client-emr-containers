...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.124.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.124.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/AqXpsfweA9p7i9hWX9W50sw6Aj2/tSwLB8wgAQvl3bBucWFPlIXB3K0rXq6mhT5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.124.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.124.0/index.min.mjs": "sha384-/AqXpsfweA9p7i9hWX9W50sw6Aj2/tSwLB8wgAQvl3bBucWFPlIXB3K0rXq6mhT5"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.124.0`)
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.124.0/LICENSE
```

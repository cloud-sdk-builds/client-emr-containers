...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RVOVd1pMh8QEFZjMNurJupwP/8W0TRMq3Zwk5Vj/R7XkMOcjehV7JHIkVvkxkrxp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.327.0/index.min.mjs": "sha384-RVOVd1pMh8QEFZjMNurJupwP/8W0TRMq3Zwk5Vj/R7XkMOcjehV7JHIkVvkxkrxp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.327.0/LICENSE
```

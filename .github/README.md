...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.292.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.292.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/cPQjO14KK2o2v5oM5u74ml74HOO+ZamFz9fHpOe0slvlpj4FdocUZrQbCS2/hTX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.292.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.292.0/index.min.mjs": "sha384-/cPQjO14KK2o2v5oM5u74ml74HOO+ZamFz9fHpOe0slvlpj4FdocUZrQbCS2/hTX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.292.0/LICENSE
```

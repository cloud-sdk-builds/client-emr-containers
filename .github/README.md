...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.981.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.981.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bW9iQCi0UO93d7+60idflEqFVuxe/nJTQ61rUTFRXYJSrd344jaY2W3AEgbpUMv6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.981.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.981.0/index.min.mjs": "sha384-bW9iQCi0UO93d7+60idflEqFVuxe/nJTQ61rUTFRXYJSrd344jaY2W3AEgbpUMv6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.981.0/LICENSE
```

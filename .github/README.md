...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.95.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.95.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wJGGtrkRRSF2KSVJMuGm8u1EZ2kQNPAj9XwuBdH6oz5qurk6ocFtfzh43DcopjzH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.95.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.95.0/index.min.mjs": "sha384-wJGGtrkRRSF2KSVJMuGm8u1EZ2kQNPAj9XwuBdH6oz5qurk6ocFtfzh43DcopjzH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.95.0/LICENSE
```

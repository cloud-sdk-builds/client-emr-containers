...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.563.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.563.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KtTdJsxvBj3pEy9+ZbW/aCA8NXGBWnZfw6fUD/RlZ1fgQhbTt5ye+bEzxoCxx4rW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.563.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.563.0/index.min.mjs": "sha384-KtTdJsxvBj3pEy9+ZbW/aCA8NXGBWnZfw6fUD/RlZ1fgQhbTt5ye+bEzxoCxx4rW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.563.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.828.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.828.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yRKS9HoBxXDQN+vRvK+7WlxkBkSq2Orrkz6hqqkCn/OcjR/UDnrqZ5EyNfq8DJe/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.828.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.828.0/index.min.mjs": "sha384-yRKS9HoBxXDQN+vRvK+7WlxkBkSq2Orrkz6hqqkCn/OcjR/UDnrqZ5EyNfq8DJe/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.828.0/LICENSE
```

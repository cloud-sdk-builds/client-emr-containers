...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.11.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.11.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qWxgCJio23kJAUhZq6/sfpHkAVTXl4mpll4u2YvzcgzyStvrS/3FA3+J3LfDkEvd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.11.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.11.0/index.min.mjs": "sha384-qWxgCJio23kJAUhZq6/sfpHkAVTXl4mpll4u2YvzcgzyStvrS/3FA3+J3LfDkEvd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.11.0/LICENSE
```

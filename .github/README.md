...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.967.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.967.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JYD9NwzeA96YmZ4+c2iSO2MjTa6QZOdFhD3CfleCDVkDz5tqSC52X5K0BTr4rK6H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.967.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.967.0/index.min.mjs": "sha384-JYD9NwzeA96YmZ4+c2iSO2MjTa6QZOdFhD3CfleCDVkDz5tqSC52X5K0BTr4rK6H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.967.0/LICENSE
```

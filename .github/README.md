...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.293.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.293.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-563QiSbkpPDiXYHVnliF+J5iEzgSUb5f7dxYgmm7YSQcfwBZsq4YJwmgw/ZX6BMU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.293.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.293.0/index.min.mjs": "sha384-563QiSbkpPDiXYHVnliF+J5iEzgSUb5f7dxYgmm7YSQcfwBZsq4YJwmgw/ZX6BMU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.293.0/LICENSE
```

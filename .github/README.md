...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1027.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1027.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9ZgJCvnhqNpdj3joU5OWGPr/WhcO1dMax4X5je9GmYR9G4POTpbY01+M7AZrPchC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1027.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1027.0/index.min.mjs": "sha384-9ZgJCvnhqNpdj3joU5OWGPr/WhcO1dMax4X5je9GmYR9G4POTpbY01+M7AZrPchC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1027.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.669.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.669.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QrWqUp9QgtZ1+fssabUsjA4w/KnONeDE0ogPkyEa4fc0vEvzI3HOGJZ9h1wrYlTn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.669.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.669.0/index.min.mjs": "sha384-QrWqUp9QgtZ1+fssabUsjA4w/KnONeDE0ogPkyEa4fc0vEvzI3HOGJZ9h1wrYlTn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.669.0/LICENSE
```

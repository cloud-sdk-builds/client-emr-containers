...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.359.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.359.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jS23SOk1T1Xj98LTz/Hso9uC/MXsG2IOboWfj5oPNrJnIKZ7E+VlrkXtk0yKHmTn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.359.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.359.0/index.min.mjs": "sha384-jS23SOk1T1Xj98LTz/Hso9uC/MXsG2IOboWfj5oPNrJnIKZ7E+VlrkXtk0yKHmTn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.359.0/LICENSE
```

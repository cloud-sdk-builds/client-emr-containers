...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.823.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.823.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VP7+7vShPVEG421GHhlcwcetEPv91JwNYd8vQarrhrq8s3Mou1H/WRzychl+DN2P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.823.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.823.0/index.min.mjs": "sha384-VP7+7vShPVEG421GHhlcwcetEPv91JwNYd8vQarrhrq8s3Mou1H/WRzychl+DN2P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.823.0/LICENSE
```

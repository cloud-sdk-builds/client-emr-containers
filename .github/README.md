...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.54.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.54.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-K3NVHn3+fP09yeEIpjZOAJWflkB6PakCsuE56uXMJrMoXUA36jkLI70pjmDA/qMP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.54.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.54.1/index.min.mjs": "sha384-K3NVHn3+fP09yeEIpjZOAJWflkB6PakCsuE56uXMJrMoXUA36jkLI70pjmDA/qMP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.54.1/LICENSE
```

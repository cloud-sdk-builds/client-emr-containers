...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VqiZl5mXN4QIBcQTynI/QomSCdSVSI+73JbNhHoq+uAWLRqVFJ135hQ6AOehso73
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.925.0/index.min.mjs": "sha384-VqiZl5mXN4QIBcQTynI/QomSCdSVSI+73JbNhHoq+uAWLRqVFJ135hQ6AOehso73"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.925.0/LICENSE
```

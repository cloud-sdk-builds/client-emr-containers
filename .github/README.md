...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.613.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.613.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aAANj3Ry94miXSsho+HRY76xlyFG81zzWMRez5oMITzihGOHYqws+5v7cQHCFAro
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.613.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.613.0/index.min.mjs": "sha384-aAANj3Ry94miXSsho+HRY76xlyFG81zzWMRez5oMITzihGOHYqws+5v7cQHCFAro"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.613.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.590.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.590.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k8mtAs40XBVptk0Xpl+Cl7lh1P8753xyjpXpzcj8Dxhy5+54eZCUB1QPiLhC8VUx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.590.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.590.0/index.min.mjs": "sha384-k8mtAs40XBVptk0Xpl+Cl7lh1P8753xyjpXpzcj8Dxhy5+54eZCUB1QPiLhC8VUx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.590.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.468.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.468.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DVI9GnKcMnWLekXHKmq48J3mwUbPHYXlELpX0qvB0jlsoiloULfpAWXS977Hz36h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.468.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.468.0/index.min.mjs": "sha384-DVI9GnKcMnWLekXHKmq48J3mwUbPHYXlELpX0qvB0jlsoiloULfpAWXS977Hz36h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.468.0/LICENSE
```

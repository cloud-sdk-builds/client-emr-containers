...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.891.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.891.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QO3cKjkTxHdQ2cHUIjZ+eVZlO1wtpuktVwgk8S94a7wcil9jO7a0jgclPxguzGn5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.891.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.891.0/index.min.mjs": "sha384-QO3cKjkTxHdQ2cHUIjZ+eVZlO1wtpuktVwgk8S94a7wcil9jO7a0jgclPxguzGn5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.891.0/LICENSE
```

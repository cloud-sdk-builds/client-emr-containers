...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1029.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1029.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+jVz7M1xAyt27J3exNr3KKaaoyMSmbBhohJf42eDy7Y2RXsAjFEMx4oNkE+KNa9+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1029.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1029.0/index.min.mjs": "sha384-+jVz7M1xAyt27J3exNr3KKaaoyMSmbBhohJf42eDy7Y2RXsAjFEMx4oNkE+KNa9+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1029.0/LICENSE
```

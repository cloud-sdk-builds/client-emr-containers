...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.296.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.296.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/W8QSz4quWJbdKeRyKDo0sP7Qpbjv7IufjPgaT1O1bTPNLE8+69VqfYAjE2E9zM8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.296.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.296.0/index.min.mjs": "sha384-/W8QSz4quWJbdKeRyKDo0sP7Qpbjv7IufjPgaT1O1bTPNLE8+69VqfYAjE2E9zM8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.296.0/LICENSE
```

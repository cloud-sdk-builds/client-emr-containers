...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.178.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.178.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xb4B+r3JAteQMI34Vi72VCZylYjyg0fdY47Yk1hMu9IO+BE2wOznUx2ScLhAFE1A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.178.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.178.0/index.min.mjs": "sha384-xb4B+r3JAteQMI34Vi72VCZylYjyg0fdY47Yk1hMu9IO+BE2wOznUx2ScLhAFE1A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.178.0/LICENSE
```

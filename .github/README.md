...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WzhR3JFqGsaI7+uFVhWz4Gcdrk8eMNo3ehCuR+ghhxS2CMKf5YjEckGZFE8t4gUp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.964.0/index.min.mjs": "sha384-WzhR3JFqGsaI7+uFVhWz4Gcdrk8eMNo3ehCuR+ghhxS2CMKf5YjEckGZFE8t4gUp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.964.0/LICENSE
```

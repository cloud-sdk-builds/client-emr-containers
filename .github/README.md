...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.879.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.879.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mp0Qul67r0ZML/9agozFB0oLNTuUJ4ht01yj5y/97aeDlA7zkO7rR1NtyY6y44hj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.879.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.879.0/index.min.mjs": "sha384-mp0Qul67r0ZML/9agozFB0oLNTuUJ4ht01yj5y/97aeDlA7zkO7rR1NtyY6y44hj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.879.0/LICENSE
```

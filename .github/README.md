...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.391.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.391.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GomYlQ0k7RGO8Q0wHU4Mw7p9fAGr6cRdMfmfjcc0rfNnQHox8Vt/cNdIT+Ma1+E2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.391.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.391.0/index.min.mjs": "sha384-GomYlQ0k7RGO8Q0wHU4Mw7p9fAGr6cRdMfmfjcc0rfNnQHox8Vt/cNdIT+Ma1+E2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.391.0/LICENSE
```

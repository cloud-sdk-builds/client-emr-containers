...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.751.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.751.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DbnQbXZ3q396yo7JS4DXtDhIHlcVHlZnUsRE6hkF4ykxmJNo/A6prTIlDn4DSv60
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.751.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.751.0/index.min.mjs": "sha384-DbnQbXZ3q396yo7JS4DXtDhIHlcVHlZnUsRE6hkF4ykxmJNo/A6prTIlDn4DSv60"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.751.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.410.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.410.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mW6PkLEobs7Q0rxTFSwC0dkKfF1FcZ2rrX0wXEv+AA5TlImR4A7OXRRhUWZdBa1C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.410.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.410.0/index.min.mjs": "sha384-mW6PkLEobs7Q0rxTFSwC0dkKfF1FcZ2rrX0wXEv+AA5TlImR4A7OXRRhUWZdBa1C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.410.0/LICENSE
```

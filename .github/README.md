...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.554.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.554.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oP1WdgTC4/29g22+/5ddhhg8xGaqZ6cnZzmujWvrnIsAOoljY0nLHeK8+zIJrkob
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.554.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.554.0/index.min.mjs": "sha384-oP1WdgTC4/29g22+/5ddhhg8xGaqZ6cnZzmujWvrnIsAOoljY0nLHeK8+zIJrkob"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.554.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3hH+tKDzqQdp5ogzb3K6TGbhbPuF7kzIbvxMxxvT2CTLiE/v44ZixrH+opa/OFkl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.525.0/index.min.mjs": "sha384-3hH+tKDzqQdp5ogzb3K6TGbhbPuF7kzIbvxMxxvT2CTLiE/v44ZixrH+opa/OFkl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.525.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.893.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.893.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-saW+PzGlfiLK2C25ZxCJd0v6DJg/rd7J7wYr+4vE80ZuwSz4vycIMvKtvdk/if89
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.893.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.893.0/index.min.mjs": "sha384-saW+PzGlfiLK2C25ZxCJd0v6DJg/rd7J7wYr+4vE80ZuwSz4vycIMvKtvdk/if89"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.893.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.987.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.987.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iyQ7Qdvq+7TkRh8ajOfwE30kZbk0+HLdrwAkYXsG19Zky0vfTeRvMlfXknQlnfyF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.987.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.987.0/index.min.mjs": "sha384-iyQ7Qdvq+7TkRh8ajOfwE30kZbk0+HLdrwAkYXsG19Zky0vfTeRvMlfXknQlnfyF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.987.0/LICENSE
```

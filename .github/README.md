...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.53.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.53.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qEs78bCU1FIVWpcoNJxfKADrd4mi91YtqCfxD99dGStf/k65xN3M/QpJ/JtDjhd8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.53.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.53.0/index.min.mjs": "sha384-qEs78bCU1FIVWpcoNJxfKADrd4mi91YtqCfxD99dGStf/k65xN3M/QpJ/JtDjhd8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.53.0/LICENSE
```

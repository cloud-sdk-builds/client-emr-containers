...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.75.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.75.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5HWmufNU72o9PmeFsQzGHGWzzqSS7Ib0OSyng8wPWLArZKpEOA4dElZYWu+tjmfY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.75.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.75.0/index.min.mjs": "sha384-5HWmufNU72o9PmeFsQzGHGWzzqSS7Ib0OSyng8wPWLArZKpEOA4dElZYWu+tjmfY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.75.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.238.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.238.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qwQG4yJ0aU4ySsgFCYqv6GRs4Ty5GzF/Hcqv5LcetnSM3Yd53ei0WtIgU8IJL0nB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.238.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.238.0/index.min.mjs": "sha384-qwQG4yJ0aU4ySsgFCYqv6GRs4Ty5GzF/Hcqv5LcetnSM3Yd53ei0WtIgU8IJL0nB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.238.0/LICENSE
```

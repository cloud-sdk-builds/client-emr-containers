...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.462.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.462.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8ElVaQRy/gJtl/fzrOkWyYzAkGLr44fR8/X8SLsTusZNDD8Vmdr/GCl42np5CRAt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.462.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.462.0/index.min.mjs": "sha384-8ElVaQRy/gJtl/fzrOkWyYzAkGLr44fR8/X8SLsTusZNDD8Vmdr/GCl42np5CRAt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.462.0/LICENSE
```

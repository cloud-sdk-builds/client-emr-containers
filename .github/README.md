...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hjb6AOhVgQ3EeuNbG09l/+pSR4gswblqTD5sy/G4ncT6jCcy6Mio0dyvtT5gVy6t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.928.0/index.min.mjs": "sha384-Hjb6AOhVgQ3EeuNbG09l/+pSR4gswblqTD5sy/G4ncT6jCcy6Mio0dyvtT5gVy6t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.928.0/LICENSE
```

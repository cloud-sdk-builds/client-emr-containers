...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.322.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.322.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lEoNVRRFcNOglMvjICkMdAR5dlUYLrQeyzR+j6L5Yroyrs53RhphItfcT9GBHKiZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.322.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.322.0/index.min.mjs": "sha384-lEoNVRRFcNOglMvjICkMdAR5dlUYLrQeyzR+j6L5Yroyrs53RhphItfcT9GBHKiZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.322.0/LICENSE
```

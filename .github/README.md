...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1024.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1024.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mDPpNTLWaNiuW+htOaR42JrK2OBTYMmdd/C0rwrRvzNAMBV2V4JJrZiL0G7Sitlj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1024.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1024.0/index.min.mjs": "sha384-mDPpNTLWaNiuW+htOaR42JrK2OBTYMmdd/C0rwrRvzNAMBV2V4JJrZiL0G7Sitlj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1024.0/LICENSE
```

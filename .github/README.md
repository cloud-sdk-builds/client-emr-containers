...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1037.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1037.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dVAPvsVKf0WNdJ4ImsBX5poHtRdzkxmY5eyqBkCoGGHsHUUcgQx21P69qXfKpb5u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1037.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1037.0/index.min.mjs": "sha384-dVAPvsVKf0WNdJ4ImsBX5poHtRdzkxmY5eyqBkCoGGHsHUUcgQx21P69qXfKpb5u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1037.0/LICENSE
```

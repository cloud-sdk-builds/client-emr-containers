...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.52.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.52.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EAo81zAtCvIhErVDUxfFIVm1V/xTSXY6tir0It9V1UAyJMgI5iasbsvJCJ8KXyxw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.52.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.52.0/index.min.mjs": "sha384-EAo81zAtCvIhErVDUxfFIVm1V/xTSXY6tir0It9V1UAyJMgI5iasbsvJCJ8KXyxw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.52.0/LICENSE
```

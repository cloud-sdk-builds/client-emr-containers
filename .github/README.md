...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.600.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.600.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5o7gjIRQN82SwAY7fGdvlwVO2TlWcjrLJNxdEUjWSN4PezJjTIbwKyIXaQCygqN5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.600.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.600.0/index.min.mjs": "sha384-5o7gjIRQN82SwAY7fGdvlwVO2TlWcjrLJNxdEUjWSN4PezJjTIbwKyIXaQCygqN5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.600.0/LICENSE
```

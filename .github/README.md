...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.234.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.234.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gVyOdCqzAhX/35vSTBbiHa8juMOc2gPm2yhSxYt/+RzhFSTyDO/rHDvpeANczRjq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.234.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.234.0/index.min.mjs": "sha384-gVyOdCqzAhX/35vSTBbiHa8juMOc2gPm2yhSxYt/+RzhFSTyDO/rHDvpeANczRjq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.234.0/LICENSE
```

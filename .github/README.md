...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.621.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.621.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QzruySHPoVIK5eY0WvUyPe3z6Q+F3Cm5zaDk63oFLNpIpLBFZjmqsW2iMKolDoZE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.621.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.621.0/index.min.mjs": "sha384-QzruySHPoVIK5eY0WvUyPe3z6Q+F3Cm5zaDk63oFLNpIpLBFZjmqsW2iMKolDoZE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.621.0/LICENSE
```

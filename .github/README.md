...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.278.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.278.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aOyottc1t9bXursMSMUMOf2bVMiwCANzq8kxsdZCR1EB6YwkY8pHb9i52Nx9aiYS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.278.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.278.0/index.min.mjs": "sha384-aOyottc1t9bXursMSMUMOf2bVMiwCANzq8kxsdZCR1EB6YwkY8pHb9i52Nx9aiYS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.278.0/LICENSE
```

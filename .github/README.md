...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.16.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.16.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZVhOP+1ITzMmmmlwlJdbDFFqEj+VkVyFz1VY8vxBa43qVeonW7clPNgHdK7UKkto
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.16.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.16.0/index.min.mjs": "sha384-ZVhOP+1ITzMmmmlwlJdbDFFqEj+VkVyFz1VY8vxBa43qVeonW7clPNgHdK7UKkto"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.16.0/LICENSE
```

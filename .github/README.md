...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.316.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.316.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1mI6Vt2dCr8tDjsfDUd1FElzNZO73DuXyzOXddjn2F0j4U7E9V0Xfd54kxtdN9HX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.316.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.316.0/index.min.mjs": "sha384-1mI6Vt2dCr8tDjsfDUd1FElzNZO73DuXyzOXddjn2F0j4U7E9V0Xfd54kxtdN9HX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.316.0/LICENSE
```

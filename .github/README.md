...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.67.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.67.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v2/uVnq4EBqmkIZAxBE8Wu3h5XRK7e7EC6W2sNiRtZVD6RbWwIExsF4XXdT+hhaf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.67.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.67.0/index.min.mjs": "sha384-v2/uVnq4EBqmkIZAxBE8Wu3h5XRK7e7EC6W2sNiRtZVD6RbWwIExsF4XXdT+hhaf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.67.0/LICENSE
```

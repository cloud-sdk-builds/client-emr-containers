...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.485.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.485.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B/m2Tz7DI4pejMeYDMt0AhGieD3SMZLY7J7Vn29Os5dW3arwp90L1V6oloSxDDC8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.485.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.485.0/index.min.mjs": "sha384-B/m2Tz7DI4pejMeYDMt0AhGieD3SMZLY7J7Vn29Os5dW3arwp90L1V6oloSxDDC8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.485.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.490.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.490.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VXsfY8gufKLwpP3xSo3Ii0CzOZQoDAiheIhO0ZxvUeEqal75Uce19l2o9NMPbCek
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.490.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.490.0/index.min.mjs": "sha384-VXsfY8gufKLwpP3xSo3Ii0CzOZQoDAiheIhO0ZxvUeEqal75Uce19l2o9NMPbCek"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.490.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.458.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.458.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KaEau7YJI1atxbwNshtO4YyMs863PNrxd1S3gJeJVVTkx0Qp9e719jweBwM9+/sy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.458.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.458.0/index.min.mjs": "sha384-KaEau7YJI1atxbwNshtO4YyMs863PNrxd1S3gJeJVVTkx0Qp9e719jweBwM9+/sy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.458.0/LICENSE
```

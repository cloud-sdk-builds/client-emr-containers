...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.588.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.588.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ElPSQk2DXtA+laYN/piCL2tbGj+CVJ1K2EY2kL7itAYDftc02HLeWus/GRHTylZR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.588.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.588.0/index.min.mjs": "sha384-ElPSQk2DXtA+laYN/piCL2tbGj+CVJ1K2EY2kL7itAYDftc02HLeWus/GRHTylZR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.588.0/LICENSE
```

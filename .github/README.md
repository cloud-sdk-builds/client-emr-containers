...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.40.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.40.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ErOnYLPOg1XgSOivP8dETjmofg+Eq/P2DWojEQYpDrqNgWskvkBS6RmNmFITvu+I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.40.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.40.0/index.min.mjs": "sha384-ErOnYLPOg1XgSOivP8dETjmofg+Eq/P2DWojEQYpDrqNgWskvkBS6RmNmFITvu+I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.40.0/LICENSE
```

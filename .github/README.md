...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.3.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.3.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qjzgyN8c7nbB9/KjG6LraPmL6FVDbR7+uHUyUui9XcNetODXFSmNVDqLzvsTqk0i
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.3.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.3.0/index.min.mjs": "sha384-qjzgyN8c7nbB9/KjG6LraPmL6FVDbR7+uHUyUui9XcNetODXFSmNVDqLzvsTqk0i"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.3.0/LICENSE
```

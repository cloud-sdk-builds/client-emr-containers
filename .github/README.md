...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.159.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.159.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7O9NIkfjLykDO9lRe/A25ecpY1Xftznv/0m/1dCeEnb/3OKDvb8IiaYM36ZUL/Wb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.159.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.159.0/index.min.mjs": "sha384-7O9NIkfjLykDO9lRe/A25ecpY1Xftznv/0m/1dCeEnb/3OKDvb8IiaYM36ZUL/Wb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.159.0/LICENSE
```

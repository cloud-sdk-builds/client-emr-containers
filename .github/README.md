...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.150.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.150.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y2n/A4WIAfLwD43Qmq4yzoKMDcTQqSH13QWt7b2Oo5YiY7NBEthWn+5S1oD9Ic1/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.150.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.150.0/index.min.mjs": "sha384-y2n/A4WIAfLwD43Qmq4yzoKMDcTQqSH13QWt7b2Oo5YiY7NBEthWn+5S1oD9Ic1/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.150.0/LICENSE
```

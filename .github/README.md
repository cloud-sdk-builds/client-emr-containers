...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yhQwPQF83ZomfvjT8i77Ep9s0PqHfCD5cRDePNzaJFGN1Rxu/SsbK6dRgWahnbjF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.986.0/index.min.mjs": "sha384-yhQwPQF83ZomfvjT8i77Ep9s0PqHfCD5cRDePNzaJFGN1Rxu/SsbK6dRgWahnbjF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.986.0/LICENSE
```

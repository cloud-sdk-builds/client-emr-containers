...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Nexcq6f+/hqucwOKCoYXguR6owU8xlTcjv+3O0blSP7iR+cuL6Yj9hhZlD6varHM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.974.0/index.min.mjs": "sha384-Nexcq6f+/hqucwOKCoYXguR6owU8xlTcjv+3O0blSP7iR+cuL6Yj9hhZlD6varHM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.974.0/LICENSE
```

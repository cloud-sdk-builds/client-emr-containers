...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6TRakt1rKS6315YW+CqGH2EcVtY1QD6x+xIaSKBErB9bKf6gqvQ/YALb0cjhAIwS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.970.0/index.min.mjs": "sha384-6TRakt1rKS6315YW+CqGH2EcVtY1QD6x+xIaSKBErB9bKf6gqvQ/YALb0cjhAIwS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.970.0/LICENSE
```

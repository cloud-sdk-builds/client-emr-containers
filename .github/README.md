...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.222.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.222.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DgF5YsdnMlQXU828HMsTrZG4sflwQ1K1eNd/bYXl7FhrdTJe3k+nMPkStCUp6a5A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.222.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.222.0/index.min.mjs": "sha384-DgF5YsdnMlQXU828HMsTrZG4sflwQ1K1eNd/bYXl7FhrdTJe3k+nMPkStCUp6a5A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.222.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.499.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.499.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wU/7yE98JQuU/Vp4FhrG3+/0MoIfTYZ/TNZ/KLrLNmOxWLAthkc8JJ5kD+sTGTDB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.499.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.499.0/index.min.mjs": "sha384-wU/7yE98JQuU/Vp4FhrG3+/0MoIfTYZ/TNZ/KLrLNmOxWLAthkc8JJ5kD+sTGTDB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.499.0/LICENSE
```

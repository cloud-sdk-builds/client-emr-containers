...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.49.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.49.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0A5cNtfOhUR7O1k+d4363YoJ/7qkaMZb/ZRPiK3kTLP9tPcP5guVHDfBmzso3k5N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.49.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.49.0/index.min.mjs": "sha384-0A5cNtfOhUR7O1k+d4363YoJ/7qkaMZb/ZRPiK3kTLP9tPcP5guVHDfBmzso3k5N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.49.0/LICENSE
```

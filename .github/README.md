...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.345.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.345.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g+miqwEG90DwGGMgTyc9HL36ulW4A5g0DUNroHH5h3rsocX+623TIIeYVoh3QlQk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.345.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.345.0/index.min.mjs": "sha384-g+miqwEG90DwGGMgTyc9HL36ulW4A5g0DUNroHH5h3rsocX+623TIIeYVoh3QlQk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.345.0/LICENSE
```

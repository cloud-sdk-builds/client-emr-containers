...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.507.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.507.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MtUXPsXVGp8J6BIEaTlxK4nDcP15IUUfs7KWFPAXdDYiwrV1czxke5W/ImRjFiTX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.507.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.507.0/index.min.mjs": "sha384-MtUXPsXVGp8J6BIEaTlxK4nDcP15IUUfs7KWFPAXdDYiwrV1czxke5W/ImRjFiTX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.507.0/LICENSE
```

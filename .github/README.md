...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.856.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.856.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-36nBHosbbZv2yy8C/Ns/3tS4BMhNvLWSt3io2+IwoRRYH/Nr6ZfP+UMqGbRvaJen
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.856.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.856.0/index.min.mjs": "sha384-36nBHosbbZv2yy8C/Ns/3tS4BMhNvLWSt3io2+IwoRRYH/Nr6ZfP+UMqGbRvaJen"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.856.0/LICENSE
```

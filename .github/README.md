...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.163.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.163.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A1ZwK8+iO8TMduq3BRVZRWh1UPmhHqxSmiAvmEUJvNrkpK1s2eLdxaAsJHeXUU97
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.163.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.163.0/index.min.mjs": "sha384-A1ZwK8+iO8TMduq3BRVZRWh1UPmhHqxSmiAvmEUJvNrkpK1s2eLdxaAsJHeXUU97"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.163.0/LICENSE
```

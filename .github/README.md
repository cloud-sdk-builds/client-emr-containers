...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.279.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.279.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qgkJxJbUGms8ydPg5P4/Ovg1DBLJx/RklyorWjW2eML+u5ah2It9IqrigG9pi83J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.279.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.279.0/index.min.mjs": "sha384-qgkJxJbUGms8ydPg5P4/Ovg1DBLJx/RklyorWjW2eML+u5ah2It9IqrigG9pi83J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.279.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.844.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.844.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kkAQVsPmCC5Gg90sDwYZ1+G3Wxp3ltbyukNkrnSSujh/HkZmZ157pt9rAv0wmDfQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.844.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.844.0/index.min.mjs": "sha384-kkAQVsPmCC5Gg90sDwYZ1+G3Wxp3ltbyukNkrnSSujh/HkZmZ157pt9rAv0wmDfQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.844.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dyvBf2hc0rKAFjjQo2vPJIyNN/W1S/Z61SPRrP7A2b2VTxHPj9wtNy4i4GeTGZWI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.504.0/index.min.mjs": "sha384-dyvBf2hc0rKAFjjQo2vPJIyNN/W1S/Z61SPRrP7A2b2VTxHPj9wtNy4i4GeTGZWI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.504.0/LICENSE
```

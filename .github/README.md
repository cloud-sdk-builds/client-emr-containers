...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.423.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mYk4v1471Datj3BVTfkYZMeFs1SCiFSYMZI5gcblDfGafxLb/UUNy81J89FN+pIv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.423.0/index.min.mjs": "sha384-mYk4v1471Datj3BVTfkYZMeFs1SCiFSYMZI5gcblDfGafxLb/UUNy81J89FN+pIv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.423.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.43.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.43.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YxwMmMGEkPzh7ji7wBWC2beLcRMFzujn4limNodqVBcNGBu96c+VDCcTpj8J97I7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.43.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.43.0/index.min.mjs": "sha384-YxwMmMGEkPzh7ji7wBWC2beLcRMFzujn4limNodqVBcNGBu96c+VDCcTpj8J97I7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.43.0/LICENSE
```

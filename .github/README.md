...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.358.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.358.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c2t+wm08MrQqzvehXFlaRgauB8H1fKEGcoKNX4WOtbR3d94t1u4jkV2g8Szt31Qq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.358.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.358.0/index.min.mjs": "sha384-c2t+wm08MrQqzvehXFlaRgauB8H1fKEGcoKNX4WOtbR3d94t1u4jkV2g8Szt31Qq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.358.0/LICENSE
```

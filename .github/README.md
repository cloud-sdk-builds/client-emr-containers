...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.162.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.162.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8Uv9rMxt7vJA2SdggOchrhxFgK2kKWwWK+fJ6dmuj/sVry9IuUy9gQzGeqc7t9ZC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.162.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.162.0/index.min.mjs": "sha384-8Uv9rMxt7vJA2SdggOchrhxFgK2kKWwWK+fJ6dmuj/sVry9IuUy9gQzGeqc7t9ZC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.162.0/LICENSE
```

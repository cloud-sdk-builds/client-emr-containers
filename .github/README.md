...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.350.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.350.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KvYHa1MkaHkAEAeJSZKpXC4I5a7+JIu21ZazRwWuv9YhopQi1t1vdNIn4b6FxMfv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.350.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.350.0/index.min.mjs": "sha384-KvYHa1MkaHkAEAeJSZKpXC4I5a7+JIu21ZazRwWuv9YhopQi1t1vdNIn4b6FxMfv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.350.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.495.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.495.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zRwunzeSVXOOtawBso8n4AFkJiET+UdFl/fZAYaQ5euS9c4b3RHiP4CyEHIC0FXM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.495.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.495.0/index.min.mjs": "sha384-zRwunzeSVXOOtawBso8n4AFkJiET+UdFl/fZAYaQ5euS9c4b3RHiP4CyEHIC0FXM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.495.0/LICENSE
```

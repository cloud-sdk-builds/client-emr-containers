...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.319.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.319.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ccEtRtRQvosDmEXX21t4Ybk436rGiTyLRBLb8xZZVTKwWkMEy05j1rACmKJ5mJMQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.319.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.319.0/index.min.mjs": "sha384-ccEtRtRQvosDmEXX21t4Ybk436rGiTyLRBLb8xZZVTKwWkMEy05j1rACmKJ5mJMQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.319.0/LICENSE
```

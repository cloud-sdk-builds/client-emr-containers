...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.489.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.489.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VFu5MvOI4wJG0E4WePD5Nt9CZnZnkOIOgYVJ05YYnDA8XbaIyKdVO0RLjB1TStay
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.489.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.489.0/index.min.mjs": "sha384-VFu5MvOI4wJG0E4WePD5Nt9CZnZnkOIOgYVJ05YYnDA8XbaIyKdVO0RLjB1TStay"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.489.0/LICENSE
```

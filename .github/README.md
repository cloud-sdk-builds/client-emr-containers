...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.352.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.352.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6bjqU4j9MRwfeesDmWlvzZkoFB8e/5d4ZmNUs5ertxK8iZWba3RIqWRLI0VPNLwZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.352.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.352.0/index.min.mjs": "sha384-6bjqU4j9MRwfeesDmWlvzZkoFB8e/5d4ZmNUs5ertxK8iZWba3RIqWRLI0VPNLwZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.352.0/LICENSE
```

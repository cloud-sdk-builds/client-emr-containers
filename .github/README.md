...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.473.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.473.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PJQqBiV//JRGi6aFTUIJs7e1Z92fcgsYt35lrrM2U4m/AIHG4rVKo3KIU1vpbU75
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.473.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.473.0/index.min.mjs": "sha384-PJQqBiV//JRGi6aFTUIJs7e1Z92fcgsYt35lrrM2U4m/AIHG4rVKo3KIU1vpbU75"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.473.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5VZGy3j9leouEiqGAm2gaUyQHBrUWwDwlccSEwmL3Pz0KZ2EDpoh73w0JNdZ/vfH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.954.0/index.min.mjs": "sha384-5VZGy3j9leouEiqGAm2gaUyQHBrUWwDwlccSEwmL3Pz0KZ2EDpoh73w0JNdZ/vfH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.954.0/LICENSE
```

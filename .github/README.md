...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0HkfPW9cZ5z5zfYh60/KhAR9tVu4lMZqQdPQmgmoWxmTcxTaqY4M2Wnu7yEAVD08
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.948.0/index.min.mjs": "sha384-0HkfPW9cZ5z5zfYh60/KhAR9tVu4lMZqQdPQmgmoWxmTcxTaqY4M2Wnu7yEAVD08"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.948.0/LICENSE
```

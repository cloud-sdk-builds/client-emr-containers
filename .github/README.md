...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.344.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.344.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RU++THSx41+zC4n/yUI8BNwU+8VAY/dNxSl/m2d9fTxD5xGsrsKJWX3FKfqyjYVg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.344.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.344.0/index.min.mjs": "sha384-RU++THSx41+zC4n/yUI8BNwU+8VAY/dNxSl/m2d9fTxD5xGsrsKJWX3FKfqyjYVg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.344.0/LICENSE
```

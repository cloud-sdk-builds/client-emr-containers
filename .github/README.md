...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f4SQVL0yTVRty5jFI4Z2PgVBNziSkLmszWVrUl3FTF321WsBPylMCXz6eO8+P6ts
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.567.0/index.min.mjs": "sha384-f4SQVL0yTVRty5jFI4Z2PgVBNziSkLmszWVrUl3FTF321WsBPylMCXz6eO8+P6ts"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.567.0/LICENSE
```

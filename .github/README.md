...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.161.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.161.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pe3fHRM6G7n+tLuYxtVsNrOPrEhrlkVGJ7k8Bx/jniKmvQCM0E9tNKHilk3Bimud
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.161.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.161.0/index.min.mjs": "sha384-pe3fHRM6G7n+tLuYxtVsNrOPrEhrlkVGJ7k8Bx/jniKmvQCM0E9tNKHilk3Bimud"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.161.0/LICENSE
```

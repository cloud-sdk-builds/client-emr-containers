...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.408.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.408.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nRRhDcNIiWlmQL/MWrY9UGhZyuE6k2nsjEokFrms2V2gyBHuzK4rHLO5CPVzaqjB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.408.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.408.0/index.min.mjs": "sha384-nRRhDcNIiWlmQL/MWrY9UGhZyuE6k2nsjEokFrms2V2gyBHuzK4rHLO5CPVzaqjB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.408.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/hr6f/hH28TTj58fT85RtehIXlYQvCGaGiY5qiVoJugSuaiiAjrqEhDgbf5vYYAs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.658.0/index.min.mjs": "sha384-/hr6f/hH28TTj58fT85RtehIXlYQvCGaGiY5qiVoJugSuaiiAjrqEhDgbf5vYYAs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.658.0/LICENSE
```

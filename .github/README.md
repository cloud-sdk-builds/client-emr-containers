...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rfw2Pe7fDTCvApgZ0V2LRQTT7A4KwilYhpsImRS3j1Ue7glCpniS5gwDSRVbHnxb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.796.0/index.min.mjs": "sha384-rfw2Pe7fDTCvApgZ0V2LRQTT7A4KwilYhpsImRS3j1Ue7glCpniS5gwDSRVbHnxb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.796.0/LICENSE
```

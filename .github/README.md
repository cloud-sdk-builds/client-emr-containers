...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.395.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.395.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d8lG14R6jD9x2e4+xkamw7msKm/2npNINznHQ3o88xQlGx0NXnW20jf/I8C/nb0j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.395.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.395.0/index.min.mjs": "sha384-d8lG14R6jD9x2e4+xkamw7msKm/2npNINznHQ3o88xQlGx0NXnW20jf/I8C/nb0j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.395.0/LICENSE
```

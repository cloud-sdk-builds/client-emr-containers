...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.758.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.758.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TumGwWiorlg+wFx7uofOYCCgX6zV6xDaLZEVRCWclL6VwJONKEFE9Xyh6L4rHPmh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.758.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.758.0/index.min.mjs": "sha384-TumGwWiorlg+wFx7uofOYCCgX6zV6xDaLZEVRCWclL6VwJONKEFE9Xyh6L4rHPmh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.758.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.167.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.167.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OpJt/G5zhYH/3bpVaBQTK91rLx/hRa/fWyRVGL+OhK+J99JuOPRs/HL0geb7ywOx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.167.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.167.0/index.min.mjs": "sha384-OpJt/G5zhYH/3bpVaBQTK91rLx/hRa/fWyRVGL+OhK+J99JuOPRs/HL0geb7ywOx"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.167.0`)
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.167.0/LICENSE
```

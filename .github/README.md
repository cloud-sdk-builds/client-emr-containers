...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.85.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.85.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0uJIfYjV00jrw4SJHkY7FtPPxcM8+DlUXnYYfIQ3Tz+8xbGBFJRP8VFWTv7lceLF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.85.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.85.0/index.min.mjs": "sha384-0uJIfYjV00jrw4SJHkY7FtPPxcM8+DlUXnYYfIQ3Tz+8xbGBFJRP8VFWTv7lceLF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.85.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.213.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.213.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-joDhd8WsVeKelNk2fkYG2JuQGZ7DEnVj1/xtyKF338PxAnTTrbwSyQbw87YNcUfC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.213.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.213.0/index.min.mjs": "sha384-joDhd8WsVeKelNk2fkYG2JuQGZ7DEnVj1/xtyKF338PxAnTTrbwSyQbw87YNcUfC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.213.0/LICENSE
```

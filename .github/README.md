...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PEdvTu3xViPYxiGQPgbrcTrM32Xo5iNx5iGPif/C2NotYDdUK+NOxhdxZK97u2RA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.687.0/index.min.mjs": "sha384-PEdvTu3xViPYxiGQPgbrcTrM32Xo5iNx5iGPif/C2NotYDdUK+NOxhdxZK97u2RA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.687.0/LICENSE
```

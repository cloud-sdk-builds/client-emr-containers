...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.645.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ob7CdCEqilgQP1nKMvKLNDHIXQvkOS3WBN3MYJAWNdBfpHyeBw1uhhcNyjy21S3i
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.645.0/index.min.mjs": "sha384-ob7CdCEqilgQP1nKMvKLNDHIXQvkOS3WBN3MYJAWNdBfpHyeBw1uhhcNyjy21S3i"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.645.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FwG2og0/Dfrf2Yi4InSY//aolUKHIe+WoWjD69GWIR/0RVYr5uIHvAfW664Vpwxj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.873.0/index.min.mjs": "sha384-FwG2og0/Dfrf2Yi4InSY//aolUKHIe+WoWjD69GWIR/0RVYr5uIHvAfW664Vpwxj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.873.0/LICENSE
```

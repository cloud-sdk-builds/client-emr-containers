...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.87.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.87.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wOztrbOhgkWQX5AtaZ03dBdWyVVqppbmqMirEsjg32GsCl+vl33l8M/sF/xK+mMK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.87.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.87.0/index.min.mjs": "sha384-wOztrbOhgkWQX5AtaZ03dBdWyVVqppbmqMirEsjg32GsCl+vl33l8M/sF/xK+mMK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.87.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.575.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.575.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6L6DxVhDeEK3GkLWf3fRGpj2gK/G3LyA1i83oK0jTVt3MsvdhBn4blak1T/9hnjT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.575.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.575.0/index.min.mjs": "sha384-6L6DxVhDeEK3GkLWf3fRGpj2gK/G3LyA1i83oK0jTVt3MsvdhBn4blak1T/9hnjT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.575.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.8.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.8.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Iov7FRZi0DFeq25strRAZO5mPUcQ33S8lhPFkeJ+WzcWRGGDsWZlwESNjdNrQVry
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.8.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.8.1/index.min.mjs": "sha384-Iov7FRZi0DFeq25strRAZO5mPUcQ33S8lhPFkeJ+WzcWRGGDsWZlwESNjdNrQVry"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.8.1/LICENSE
```

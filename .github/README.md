...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ib8IEz80sd4rdjR6Mfate7zYzilezCtJ0FNzzc4czOqtfnzw+bP+GxJGRrJqDc8h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.58.0/index.min.mjs": "sha384-ib8IEz80sd4rdjR6Mfate7zYzilezCtJ0FNzzc4czOqtfnzw+bP+GxJGRrJqDc8h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.58.0/LICENSE
```

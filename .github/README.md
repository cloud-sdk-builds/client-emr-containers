...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.620.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.620.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-8yON40coFxhe1MbSuuNTOtha9CuuwdnPI0ar/WP+sHxmoI2J0Ja+ynru1j5xqNAB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.620.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.620.1/index.min.mjs": "sha384-8yON40coFxhe1MbSuuNTOtha9CuuwdnPI0ar/WP+sHxmoI2J0Ja+ynru1j5xqNAB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.620.1/LICENSE
```

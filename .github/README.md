...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1011.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1011.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LLzKMBUGt2fGaimVv6Bo9ongmzD8H89fShNl+ciqu7O7OhsGKQ1MEvKFplTlcMz4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1011.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1011.0/index.min.mjs": "sha384-LLzKMBUGt2fGaimVv6Bo9ongmzD8H89fShNl+ciqu7O7OhsGKQ1MEvKFplTlcMz4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1011.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.969.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.969.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Te0DZPnj59zkxqgmm9mSF6Ra6/L66BvOzGeSgTbJ2BdZDdFyCfoPhGoZg9vYzlfT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.969.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.969.0/index.min.mjs": "sha384-Te0DZPnj59zkxqgmm9mSF6Ra6/L66BvOzGeSgTbJ2BdZDdFyCfoPhGoZg9vYzlfT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.969.0/LICENSE
```

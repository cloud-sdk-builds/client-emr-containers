...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wZVTIr2isjOK3PVtiw5mA2c5ztCw8zUjG6Heebi4R01KWHVsdeNtsdoFGOLbF85/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.816.0/index.min.mjs": "sha384-wZVTIr2isjOK3PVtiw5mA2c5ztCw8zUjG6Heebi4R01KWHVsdeNtsdoFGOLbF85/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.816.0/LICENSE
```

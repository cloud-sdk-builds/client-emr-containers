...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.461.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.461.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SD++eoPBklGXhu/TIRdDSWNW/lKVunFZPyKl8u9xBEnVt91m27LXjlBfELih7xLI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.461.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.461.0/index.min.mjs": "sha384-SD++eoPBklGXhu/TIRdDSWNW/lKVunFZPyKl8u9xBEnVt91m27LXjlBfELih7xLI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.461.0/LICENSE
```

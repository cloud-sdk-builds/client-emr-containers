...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.428.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.428.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-soTXlwZz+8caxryX1jlwsyjF4iTOs/PB70HigVReLWyjoQ0mSAfPgjVhXepwnGvt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.428.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.428.0/index.min.mjs": "sha384-soTXlwZz+8caxryX1jlwsyjF4iTOs/PB70HigVReLWyjoQ0mSAfPgjVhXepwnGvt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.428.0/LICENSE
```

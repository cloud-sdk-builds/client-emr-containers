...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YrlUUZuv81xJ+dKoTvTiV3uLH8RcKjMqZll3QW3ejB3P/me7T13YlvGn6nXLo0pn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.289.0/index.min.mjs": "sha384-YrlUUZuv81xJ+dKoTvTiV3uLH8RcKjMqZll3QW3ejB3P/me7T13YlvGn6nXLo0pn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.289.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.6.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.6.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-q89gtywb0xNq2HmYBgl6/vl4+vd5EssZvhqsmHcyToV1M4Sb9Aj9b0MCD3uAezwb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.6.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.6.1/index.min.mjs": "sha384-q89gtywb0xNq2HmYBgl6/vl4+vd5EssZvhqsmHcyToV1M4Sb9Aj9b0MCD3uAezwb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.6.1/LICENSE
```

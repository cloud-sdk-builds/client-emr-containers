...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.105.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.105.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vo4fEXgbQ3FgJvRoD+1Y97izCl9pYvW9hWS2RfeLVV33UZZRp1GI9Ewgh3FOLAQG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.105.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.105.0/index.min.mjs": "sha384-vo4fEXgbQ3FgJvRoD+1Y97izCl9pYvW9hWS2RfeLVV33UZZRp1GI9Ewgh3FOLAQG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.105.0/LICENSE
```

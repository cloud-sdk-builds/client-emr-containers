...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.209.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.209.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xWndzwuXv2G7fna9ciyyC9fCw27Up3TiQB3RU0qVnoE3pEfm9kbUoB97qSfVcpM+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.209.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.209.0/index.min.mjs": "sha384-xWndzwuXv2G7fna9ciyyC9fCw27Up3TiQB3RU0qVnoE3pEfm9kbUoB97qSfVcpM+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.209.0/LICENSE
```

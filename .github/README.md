...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1007.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1007.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iWx2kbpxTgKrSgLPtnmlCfY8nIT3jLgkuPOVfufkPVDzwFU1ZngD5N9IvDZEICLp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1007.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1007.0/index.min.mjs": "sha384-iWx2kbpxTgKrSgLPtnmlCfY8nIT3jLgkuPOVfufkPVDzwFU1ZngD5N9IvDZEICLp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1007.0/LICENSE
```

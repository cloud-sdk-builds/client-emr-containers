...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1013.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1013.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1Fcc5FKmRfKptfkdiS+U0DEHMxLA7s5k1VWpTgkOUuIvW6+0fNOKmCnI+nvC909A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1013.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1013.0/index.min.mjs": "sha384-1Fcc5FKmRfKptfkdiS+U0DEHMxLA7s5k1VWpTgkOUuIvW6+0fNOKmCnI+nvC909A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1013.0/LICENSE
```

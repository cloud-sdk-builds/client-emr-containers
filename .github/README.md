...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.989.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.989.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-69EKagdQMx+STL9W8Re3ZPyrIZVyERJMm1oRtnDGTyAbzQtEOHOVNbI0OrAJw7VY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.989.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.989.0/index.min.mjs": "sha384-69EKagdQMx+STL9W8Re3ZPyrIZVyERJMm1oRtnDGTyAbzQtEOHOVNbI0OrAJw7VY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.989.0/LICENSE
```

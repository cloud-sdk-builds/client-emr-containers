...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hw9ApjexQzCtE80G0Qd4u3vjdWPOnvbGYsHjF7yIgFY6RQNU9yV32Hcjj8mr+Frf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.726.1/index.min.mjs": "sha384-Hw9ApjexQzCtE80G0Qd4u3vjdWPOnvbGYsHjF7yIgFY6RQNU9yV32Hcjj8mr+Frf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.726.1/LICENSE
```

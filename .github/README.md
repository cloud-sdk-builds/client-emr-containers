...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.10.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.10.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lmELh8yrd1Xh0IKL4qFTSdN2guF4UPO78I4tv3IruWTkI7COgy+y05cXAHyZS4w/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.10.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.10.0/index.min.mjs": "sha384-lmELh8yrd1Xh0IKL4qFTSdN2guF4UPO78I4tv3IruWTkI7COgy+y05cXAHyZS4w/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.10.0/LICENSE
```

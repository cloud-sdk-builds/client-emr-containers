...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.6.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.6.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zInnU8IJ4gpbwywBTkmIUDKqSI/JgN5Yk64C4w5/Z+FSo9AIW/j76gK6AkoQshZZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.6.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.6.0/index.min.mjs": "sha384-zInnU8IJ4gpbwywBTkmIUDKqSI/JgN5Yk64C4w5/Z+FSo9AIW/j76gK6AkoQshZZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.6.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.808.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.808.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JYKRMPB+1NInteETon1o9Ir+IwalfvNfNEkBsZdFj3JDeLAo2n1rlbavMijebfMN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.808.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.808.0/index.min.mjs": "sha384-JYKRMPB+1NInteETon1o9Ir+IwalfvNfNEkBsZdFj3JDeLAo2n1rlbavMijebfMN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.808.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.658.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.658.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-bDl9s4Bq/WgiOJodhT0okvnu6wCb+eYVOMN2KTHYgNGXc8l7BzULOSpbuvkqMHPG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.658.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.658.1/index.min.mjs": "sha384-bDl9s4Bq/WgiOJodhT0okvnu6wCb+eYVOMN2KTHYgNGXc8l7BzULOSpbuvkqMHPG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.658.1/LICENSE
```

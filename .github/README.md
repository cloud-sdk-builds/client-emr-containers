...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.998.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.998.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1JuTAhajlR5+UpbSeOGqZdksIqpbMb6KlADHE4G2SUYLuF8REc1jj2qmwxW0em+l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.998.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.998.0/index.min.mjs": "sha384-1JuTAhajlR5+UpbSeOGqZdksIqpbMb6KlADHE4G2SUYLuF8REc1jj2qmwxW0em+l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.998.0/LICENSE
```

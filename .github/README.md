...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.427.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.427.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RP+c+KjJM2ozK0bi4ofMzz8GJ2CqzMCcVh2nccJ0XR/kOeBb7I5A1veoK8NcoJca
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.427.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.427.0/index.min.mjs": "sha384-RP+c+KjJM2ozK0bi4ofMzz8GJ2CqzMCcVh2nccJ0XR/kOeBb7I5A1veoK8NcoJca"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.427.0/LICENSE
```

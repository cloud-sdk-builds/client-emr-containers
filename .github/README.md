...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.990.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.990.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9zDaiFbJgAL0/xIgH0iU7E1cpgWEEOWCldn5XVUUDdwbYr8A5x6qKaVCnV3CDvvf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.990.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.990.0/index.min.mjs": "sha384-9zDaiFbJgAL0/xIgH0iU7E1cpgWEEOWCldn5XVUUDdwbYr8A5x6qKaVCnV3CDvvf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.990.0/LICENSE
```

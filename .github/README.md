...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-opL8uiyAUdljkWOG1V7EPEuKWjSXHJwQ/wQznNdN7bprpbcNMfh0u1WuSFdlh4qx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.919.0/index.min.mjs": "sha384-opL8uiyAUdljkWOG1V7EPEuKWjSXHJwQ/wQznNdN7bprpbcNMfh0u1WuSFdlh4qx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.919.0/LICENSE
```

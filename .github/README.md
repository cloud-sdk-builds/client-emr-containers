...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.460.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.460.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yswhJOjD06+qqkYDqR7XJAWaEbbM2T04A8w+432M9z7PWWx0aVSDoXaKErQQYuPb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.460.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.460.0/index.min.mjs": "sha384-yswhJOjD06+qqkYDqR7XJAWaEbbM2T04A8w+432M9z7PWWx0aVSDoXaKErQQYuPb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.460.0/LICENSE
```

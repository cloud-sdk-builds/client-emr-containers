...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.287.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.287.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kI+qjbDEFXe4rE6IQvpJUPHws1oeEdgKurZN4DfxHdb7LDxn6T4pFNQjQr9b59WF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.287.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.287.0/index.min.mjs": "sha384-kI+qjbDEFXe4rE6IQvpJUPHws1oeEdgKurZN4DfxHdb7LDxn6T4pFNQjQr9b59WF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.287.0/LICENSE
```

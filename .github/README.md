...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.665.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.665.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dxqfH1sWD/vN0JCxD5xuTxlrm31iSTnRMnXDiM+w4iDRjQh9TgXlomPbj8dm34wh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.665.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.665.0/index.min.mjs": "sha384-dxqfH1sWD/vN0JCxD5xuTxlrm31iSTnRMnXDiM+w4iDRjQh9TgXlomPbj8dm34wh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.665.0/LICENSE
```

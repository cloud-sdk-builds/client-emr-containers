...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XJLtH3ydZ/lamlUYs9gmki+Yb2IRiRxkgxRvY/UIwIO0E1fozY/E++TbfDNqkj1O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.692.0/index.min.mjs": "sha384-XJLtH3ydZ/lamlUYs9gmki+Yb2IRiRxkgxRvY/UIwIO0E1fozY/E++TbfDNqkj1O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.692.0/LICENSE
```

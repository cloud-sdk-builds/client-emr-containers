...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.256.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.256.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Pkr/80e0rxRfMouMso7YPeC05qKQuP/J82Df4AQANrCBSrGSLmUdTN9WX71dChwJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.256.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.256.0/index.min.mjs": "sha384-Pkr/80e0rxRfMouMso7YPeC05qKQuP/J82Df4AQANrCBSrGSLmUdTN9WX71dChwJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.256.0/LICENSE
```

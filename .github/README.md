...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.288.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.288.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jZge8SDtwgZp2i2keCISz3v3x7sZ0mZ5O3XjksEsjP/KgGMcvbwcXU9JUNqG/dUa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.288.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.288.0/index.min.mjs": "sha384-jZge8SDtwgZp2i2keCISz3v3x7sZ0mZ5O3XjksEsjP/KgGMcvbwcXU9JUNqG/dUa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.288.0/LICENSE
```

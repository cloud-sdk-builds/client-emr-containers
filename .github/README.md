...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a0b2M/wWo4THH7SN79FV7jK/RPKpTBX8GIWbQKmdjKb+bKI9izEutWsVhQx9dA+8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.666.0/index.min.mjs": "sha384-a0b2M/wWo4THH7SN79FV7jK/RPKpTBX8GIWbQKmdjKb+bKI9izEutWsVhQx9dA+8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.666.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.496.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.496.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IoiLwjmQ5IpKCT3JF5bjREo6F+MF1kAEqrN0m/6yy1Sg/G7MGANlERmzFYoOCZuK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.496.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.496.0/index.min.mjs": "sha384-IoiLwjmQ5IpKCT3JF5bjREo6F+MF1kAEqrN0m/6yy1Sg/G7MGANlERmzFYoOCZuK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.496.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.37.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.37.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3XNJ2bdrWAmNYqI2lsbGQ+iwEuSoPe2YuE/xRUMWBTAYWg0c5HGFRmp9uk5YcqaH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.37.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.37.0/index.min.mjs": "sha384-3XNJ2bdrWAmNYqI2lsbGQ+iwEuSoPe2YuE/xRUMWBTAYWg0c5HGFRmp9uk5YcqaH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.37.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.342.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.342.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XpVZCYNCmKD4KAqS2HKqf4ABJDX7RQBwaKAFfZz1U+C0aC/1DbRvzbGC5xB1iLcg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.342.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.342.0/index.min.mjs": "sha384-XpVZCYNCmKD4KAqS2HKqf4ABJDX7RQBwaKAFfZz1U+C0aC/1DbRvzbGC5xB1iLcg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.342.0/LICENSE
```

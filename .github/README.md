...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.15.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.15.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZRfSojRDdTMWOTuKQvHW06j1tlCm6u8mXkrNdMLI2N9674NIjASnSbKhdrGp0U0H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.15.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.15.0/index.min.mjs": "sha384-ZRfSojRDdTMWOTuKQvHW06j1tlCm6u8mXkrNdMLI2N9674NIjASnSbKhdrGp0U0H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.15.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a8lOJ1Fz+NoTAjuYdAwGdeTXQf9QOt3igIhI4W4RJIWx6Xzf3ChDtIhuvgrM5/mD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.192.0/index.min.mjs": "sha384-a8lOJ1Fz+NoTAjuYdAwGdeTXQf9QOt3igIhI4W4RJIWx6Xzf3ChDtIhuvgrM5/mD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.192.0/LICENSE
```

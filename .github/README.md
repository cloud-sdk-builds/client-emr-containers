...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1014.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1014.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7MFAQEABHvDGBszfy6vdC2+Kw+Wqz7N/c8QLgDgHwRNG3GoGpUZ9Lmg9xo/wEuKC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1014.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1014.0/index.min.mjs": "sha384-7MFAQEABHvDGBszfy6vdC2+Kw+Wqz7N/c8QLgDgHwRNG3GoGpUZ9Lmg9xo/wEuKC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1014.0/LICENSE
```

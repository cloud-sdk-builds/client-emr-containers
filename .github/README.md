...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.664.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.664.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N+wgQjupz4yMTRjBN+4ANhgYPYVejmHvf1b5YztaZBhzwy4HiHu9FyDinmXR8Zil
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.664.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.664.0/index.min.mjs": "sha384-N+wgQjupz4yMTRjBN+4ANhgYPYVejmHvf1b5YztaZBhzwy4HiHu9FyDinmXR8Zil"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.664.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-08mr+imKhKCzMEbn5v0yVGowVd9pMwTKiBuHbErI01aAlcjeBeHfUhacmYrbK5bE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.968.0/index.min.mjs": "sha384-08mr+imKhKCzMEbn5v0yVGowVd9pMwTKiBuHbErI01aAlcjeBeHfUhacmYrbK5bE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.968.0/LICENSE
```

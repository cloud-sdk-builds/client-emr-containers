...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.51.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.51.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DCyDzYGgEN1ASq7tcitBmrjYffa6UjJin0Bu2KRYW4fj3bZGAvyjpNynteNqyANK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.51.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.51.0/index.min.mjs": "sha384-DCyDzYGgEN1ASq7tcitBmrjYffa6UjJin0Bu2KRYW4fj3bZGAvyjpNynteNqyANK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.51.0/LICENSE
```

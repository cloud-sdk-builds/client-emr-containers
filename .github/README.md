...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.721.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.721.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Fh22bN5AvTkYGXskuof2J8LGVqsA6PRolm9pdUcdRudBUaA5P4fM2N1NUJmxDc04
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.721.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.721.0/index.min.mjs": "sha384-Fh22bN5AvTkYGXskuof2J8LGVqsA6PRolm9pdUcdRudBUaA5P4fM2N1NUJmxDc04"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.721.0/LICENSE
```

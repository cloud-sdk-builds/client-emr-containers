...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.509.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.509.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Q5UN2glshrBCMm22Bwf+oMj6QPDY/jDdTtlQM62O+Nmp7sQyVrhSgAUKB6p+W3Ag
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.509.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.509.0/index.min.mjs": "sha384-Q5UN2glshrBCMm22Bwf+oMj6QPDY/jDdTtlQM62O+Nmp7sQyVrhSgAUKB6p+W3Ag"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.509.0/LICENSE
```

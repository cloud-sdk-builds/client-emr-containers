...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.887.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.887.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z44dVOWwLnK74HsatV8lGx2rXWRP3uV9z8sUn6ZLeoz9zzn1zXs/O7QgRkQwa0Dc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.887.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.887.0/index.min.mjs": "sha384-z44dVOWwLnK74HsatV8lGx2rXWRP3uV9z8sUn6ZLeoz9zzn1zXs/O7QgRkQwa0Dc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.887.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lMP2NAZLIoyRIYy9ZxvFvvMiw8/EeHPxvbrTDwyIiF/w4CAUKRdN0qhu4Qk7Mw46
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.315.0/index.min.mjs": "sha384-lMP2NAZLIoyRIYy9ZxvFvvMiw8/EeHPxvbrTDwyIiF/w4CAUKRdN0qhu4Qk7Mw46"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.315.0/LICENSE
```

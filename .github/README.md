...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-48o/aiOPv6M8YRz4vp8A/juX5O1qyiQGIQkwbY06twAvxZGdQ5ExvlUipdWgVtQ6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.224.0/index.min.mjs": "sha384-48o/aiOPv6M8YRz4vp8A/juX5O1qyiQGIQkwbY06twAvxZGdQ5ExvlUipdWgVtQ6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.224.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.185.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.185.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7HLGBh4ux5fXF6Pp7awTHa8E90znf1Fx5QQnjskK2tyPgBvhUDqoH71mISU4KpnK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.185.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.185.0/index.min.mjs": "sha384-7HLGBh4ux5fXF6Pp7awTHa8E90znf1Fx5QQnjskK2tyPgBvhUDqoH71mISU4KpnK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.185.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.441.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.441.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vuX7SYD6R2WtIIbAXaybQh4IW8xKxAzoMh2oCLrDtvObQXMLgKoJVkR88LXaTGQu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.441.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.441.0/index.min.mjs": "sha384-vuX7SYD6R2WtIIbAXaybQh4IW8xKxAzoMh2oCLrDtvObQXMLgKoJVkR88LXaTGQu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.441.0/LICENSE
```

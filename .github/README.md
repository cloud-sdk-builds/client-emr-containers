...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.170.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.170.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NN/CsYpR+62AGtmN+G6NzQIccqG7AJzpzHp3vtEhvScfDn4fYiHwIS2WtgyQ6v3g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.170.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.170.0/index.min.mjs": "sha384-NN/CsYpR+62AGtmN+G6NzQIccqG7AJzpzHp3vtEhvScfDn4fYiHwIS2WtgyQ6v3g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.170.0/LICENSE
```

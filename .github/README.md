...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1036.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1036.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6Tt3OfT2+TFIx0hx/rZ8OiKw9/XJ+TSLK2GeS2t9TTWeOq/vWXNOdvvcvcnmhcfN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1036.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1036.0/index.min.mjs": "sha384-6Tt3OfT2+TFIx0hx/rZ8OiKw9/XJ+TSLK2GeS2t9TTWeOq/vWXNOdvvcvcnmhcfN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1036.0/LICENSE
```

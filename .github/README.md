...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TEW2I1S3HmK5WMpJZ6zOAogsPA1chxb65yx8CHEzJoqUY7AdC8NewcYkemRERXZe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.435.0/index.min.mjs": "sha384-TEW2I1S3HmK5WMpJZ6zOAogsPA1chxb65yx8CHEzJoqUY7AdC8NewcYkemRERXZe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.435.0/LICENSE
```

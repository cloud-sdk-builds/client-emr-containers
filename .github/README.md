...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.668.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.668.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Cok8jrxvQ37dc7rGzy4ztkJobyyhdMS5sy8wUkBj4aJL+MhRRwVEMQw5LUIxBdE1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.668.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.668.0/index.min.mjs": "sha384-Cok8jrxvQ37dc7rGzy4ztkJobyyhdMS5sy8wUkBj4aJL+MhRRwVEMQw5LUIxBdE1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.668.0/LICENSE
```

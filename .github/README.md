...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IkZGczh9wg+3VA/DTahSROwwEQLgnHWXvWIwIRE+HSoJuz3P60ruHvjMVj3Z8fic
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.991.0/index.min.mjs": "sha384-IkZGczh9wg+3VA/DTahSROwwEQLgnHWXvWIwIRE+HSoJuz3P60ruHvjMVj3Z8fic"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.991.0/LICENSE
```

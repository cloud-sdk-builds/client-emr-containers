...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.100.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KfcN5546M5HvWsFyWk0C5dx96gykat3sNI3UAXbhrNyYzxg9oTLEpU2NCtHMLaxq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.100.0/index.min.mjs": "sha384-KfcN5546M5HvWsFyWk0C5dx96gykat3sNI3UAXbhrNyYzxg9oTLEpU2NCtHMLaxq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.100.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.183.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.183.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gZjXkB0UK9/tSpETLcCl7U93VJic+g7fp6OK9+aPLvxkO0Z/8eJW9usQHFrjdzCn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.183.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.183.0/index.min.mjs": "sha384-gZjXkB0UK9/tSpETLcCl7U93VJic+g7fp6OK9+aPLvxkO0Z/8eJW9usQHFrjdzCn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.183.0/LICENSE
```

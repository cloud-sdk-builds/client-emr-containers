...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GPLuSRcE1AE0CNKF2FOIPR4yEyHqASaxGU/PXwDuv7o1SMpZk57BXUtCbU16i8UB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.624.0/index.min.mjs": "sha384-GPLuSRcE1AE0CNKF2FOIPR4yEyHqASaxGU/PXwDuv7o1SMpZk57BXUtCbU16i8UB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.624.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.635.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.635.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qufu29PRLlZZjl7vb4UYiz1dWIrnbsx4ixt/clctPABSUH80TwZ83mwF8ZBZSg4M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.635.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.635.0/index.min.mjs": "sha384-qufu29PRLlZZjl7vb4UYiz1dWIrnbsx4ixt/clctPABSUH80TwZ83mwF8ZBZSg4M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.635.0/LICENSE
```

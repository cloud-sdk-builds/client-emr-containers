...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.354.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.354.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LGXskV4IRXEetjnHhJt+u7oX9REaBeCagmfPsncsk+1px9uZqQicWhzo9JjM+Rix
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.354.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.354.0/index.min.mjs": "sha384-LGXskV4IRXEetjnHhJt+u7oX9REaBeCagmfPsncsk+1px9uZqQicWhzo9JjM+Rix"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.354.0/LICENSE
```

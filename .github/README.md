...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.920.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.920.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-U9+x9hkuMJOjUKhQf/6DX+BTerk/UXQ21phta5e6olDAaeGwK3Jbqd+44H1usRaD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.920.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.920.0/index.min.mjs": "sha384-U9+x9hkuMJOjUKhQf/6DX+BTerk/UXQ21phta5e6olDAaeGwK3Jbqd+44H1usRaD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.920.0/LICENSE
```

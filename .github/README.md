...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.774.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.774.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hzzyUeq21e2bqvYSMY7KiPKMQuw8qr+/kx1RcaLNTUSWutHFuOg3bAfvExo8cMkh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.774.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.774.0/index.min.mjs": "sha384-hzzyUeq21e2bqvYSMY7KiPKMQuw8qr+/kx1RcaLNTUSWutHFuOg3bAfvExo8cMkh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.774.0/LICENSE
```

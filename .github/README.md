...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.54.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.54.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q6kR6AkSWRcJ7J8XYE9sZoi6dze1Xq1QpJNd8g/sZr0xNMBfSw64kU6eyR9myC2V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.54.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.54.0/index.min.mjs": "sha384-q6kR6AkSWRcJ7J8XYE9sZoi6dze1Xq1QpJNd8g/sZr0xNMBfSw64kU6eyR9myC2V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.54.0/LICENSE
```

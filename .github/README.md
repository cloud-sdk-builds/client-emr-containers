...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.953.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.953.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gt1Rhjec81e2+mRIHq6FWGOCnxM2bywT5Q69aVWYwfNqwr/6wso3KQhAoFZDNoj3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.953.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.953.0/index.min.mjs": "sha384-Gt1Rhjec81e2+mRIHq6FWGOCnxM2bywT5Q69aVWYwfNqwr/6wso3KQhAoFZDNoj3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.953.0/LICENSE
```

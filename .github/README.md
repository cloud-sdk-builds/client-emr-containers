...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GY6c87i96+intDwcjQXG5FC29EMmo+G4Kudbe7hD+MtH9gNlLo2EjFvFM4m153hs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.738.0/index.min.mjs": "sha384-GY6c87i96+intDwcjQXG5FC29EMmo+G4Kudbe7hD+MtH9gNlLo2EjFvFM4m153hs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.738.0/LICENSE
```

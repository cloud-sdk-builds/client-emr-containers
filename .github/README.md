...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.514.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.514.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s1HGtwUU+kgaqtadXrkccVEA/U0Ru+dNklDJyo21OdADIXcf6Qnf1O2436MiEVsc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.514.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.514.0/index.min.mjs": "sha384-s1HGtwUU+kgaqtadXrkccVEA/U0Ru+dNklDJyo21OdADIXcf6Qnf1O2436MiEVsc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.514.0/LICENSE
```

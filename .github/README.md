...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xB//Bma8mlqb1Mzv2KlGDjEoad5znhLYflqr3OyZPwWw8y6oNxwPKBfzF9FdW2P9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.908.0/index.min.mjs": "sha384-xB//Bma8mlqb1Mzv2KlGDjEoad5znhLYflqr3OyZPwWw8y6oNxwPKBfzF9FdW2P9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.908.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.19.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.19.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5YlNjXoAkiionTZa8ICPsqZqi24sOCvnz1zUW6rxn4W044n2ptf3UHAqhFd/NCwN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.19.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.19.0/index.min.mjs": "sha384-5YlNjXoAkiionTZa8ICPsqZqi24sOCvnz1zUW6rxn4W044n2ptf3UHAqhFd/NCwN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.19.0/LICENSE
```

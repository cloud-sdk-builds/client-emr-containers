...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.142.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.142.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3GZzR04OX4CX/F/5Vx6j/HLbluEKiWo4ZzHLYXPGcbjXIMnOUSSsDrEKgJd1tys/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.142.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.142.0/index.min.mjs": "sha384-3GZzR04OX4CX/F/5Vx6j/HLbluEKiWo4ZzHLYXPGcbjXIMnOUSSsDrEKgJd1tys/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.142.0/LICENSE
```

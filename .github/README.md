...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.27.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.27.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8LF7fhMpyWbgPMxTZEz1yjXqD2pLxWIox2HCHNcFk/PkkmOR4qgGzgU1aTW8RekR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.27.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.27.0/index.min.mjs": "sha384-8LF7fhMpyWbgPMxTZEz1yjXqD2pLxWIox2HCHNcFk/PkkmOR4qgGzgU1aTW8RekR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.27.0/LICENSE
```

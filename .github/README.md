...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1041.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1041.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sOYydFaGTbDaKDylogij0AAiZ1tOuljJkJu5yHj6Jms08xjFBeZ/h+iT/8kfXU6f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1041.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1041.0/index.min.mjs": "sha384-sOYydFaGTbDaKDylogij0AAiZ1tOuljJkJu5yHj6Jms08xjFBeZ/h+iT/8kfXU6f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1041.0/LICENSE
```

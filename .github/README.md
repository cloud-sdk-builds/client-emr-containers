...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ovrgc8eAcd2ryLKX++qRjuYthotJYxMa+oKN4QTnBAHLSw2yQ2YmR1UDndQYt76H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.616.0/index.min.mjs": "sha384-ovrgc8eAcd2ryLKX++qRjuYthotJYxMa+oKN4QTnBAHLSw2yQ2YmR1UDndQYt76H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.616.0/LICENSE
```

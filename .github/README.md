...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.360.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.360.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YcPOm0l4DMIXnvzVTszHGmon+berfNpngjFbj0oePKUuJmLb2ENI6ln3sdbJDcEF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.360.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.360.0/index.min.mjs": "sha384-YcPOm0l4DMIXnvzVTszHGmon+berfNpngjFbj0oePKUuJmLb2ENI6ln3sdbJDcEF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.360.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PoeVGQTPrQ8hnGq1eYdgGNsabuzMIBFyoNRy6r3D46nfY9Vryotdx+vC5b4Efmnw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.916.0/index.min.mjs": "sha384-PoeVGQTPrQ8hnGq1eYdgGNsabuzMIBFyoNRy6r3D46nfY9Vryotdx+vC5b4Efmnw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.916.0/LICENSE
```

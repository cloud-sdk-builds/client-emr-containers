...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.272.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.272.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Oq2OrkPnt/zlLU5OGoALf380ZWC8aAqoDJia0iiOJKA6wYJj+IvovrJF5Wda9XIL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.272.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.272.0/index.min.mjs": "sha384-Oq2OrkPnt/zlLU5OGoALf380ZWC8aAqoDJia0iiOJKA6wYJj+IvovrJF5Wda9XIL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.272.0/LICENSE
```

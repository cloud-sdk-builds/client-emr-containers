...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8QJuZp03svgFlu10wxeAVZ/LwD3rW/tY9QK241sAeKpTa2Wea7CaWsqNLOMcpL/7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.662.0/index.min.mjs": "sha384-8QJuZp03svgFlu10wxeAVZ/LwD3rW/tY9QK241sAeKpTa2Wea7CaWsqNLOMcpL/7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.662.0/LICENSE
```

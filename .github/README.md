...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WOvCmJBAyK6in4tktfWtzb4URHdk88GwaHBfzjxCVxHX0/hDmq5ztp0jXF1jkc5X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.310.0/index.min.mjs": "sha384-WOvCmJBAyK6in4tktfWtzb4URHdk88GwaHBfzjxCVxHX0/hDmq5ztp0jXF1jkc5X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.310.0/LICENSE
```

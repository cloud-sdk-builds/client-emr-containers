...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.127.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6/JhtixBipIuAwiJzxVGqhrc/H/0/nsfDlChoAwnIFvZfk1T891oBXjS6mWm909e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.127.0/index.min.mjs": "sha384-6/JhtixBipIuAwiJzxVGqhrc/H/0/nsfDlChoAwnIFvZfk1T891oBXjS6mWm909e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.127.0/LICENSE
```

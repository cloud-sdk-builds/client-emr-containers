...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.983.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.983.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tqxMTnYuvv2sGZDW321zoWqQtac/KqzwzS3JZE2Mi2M9nM/dtLqbj+eGHS23iSKO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.983.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.983.0/index.min.mjs": "sha384-tqxMTnYuvv2sGZDW321zoWqQtac/KqzwzS3JZE2Mi2M9nM/dtLqbj+eGHS23iSKO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.983.0/LICENSE
```

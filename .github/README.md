...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.193.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.193.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-enZwaqMV8o9y3pBjNpkJSrFqXHd4KM+WjnlC3yMFS6k1rQfK27stuh8AGrlSRha/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.193.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.193.0/index.min.mjs": "sha384-enZwaqMV8o9y3pBjNpkJSrFqXHd4KM+WjnlC3yMFS6k1rQfK27stuh8AGrlSRha/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.193.0/LICENSE
```

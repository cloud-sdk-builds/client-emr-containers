...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.386.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.386.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QFHyU2WxLVFRFHHS5V6Dl5tKOouQtxyg8z9kQrY8xDYITXXPZDU28gJypfqgw/Qh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.386.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.386.0/index.min.mjs": "sha384-QFHyU2WxLVFRFHHS5V6Dl5tKOouQtxyg8z9kQrY8xDYITXXPZDU28gJypfqgw/Qh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.386.0/LICENSE
```

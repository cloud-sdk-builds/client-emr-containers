...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.112.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.112.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mTJS7SoWmHKQCtp155pG5CJvBF1jmL48/l1ENX8jpp/ae17yQ5YUETyIWj7IpAKh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.112.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.112.0/index.min.mjs": "sha384-mTJS7SoWmHKQCtp155pG5CJvBF1jmL48/l1ENX8jpp/ae17yQ5YUETyIWj7IpAKh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.112.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.180.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.180.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5scbF5fyxMMCbf5pxDRJyqMdQjWB3wtYSI62gCSltAy6Zxk/aCtN3+ASmPhrvZgB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.180.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.180.0/index.min.mjs": "sha384-5scbF5fyxMMCbf5pxDRJyqMdQjWB3wtYSI62gCSltAy6Zxk/aCtN3+ASmPhrvZgB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.180.0/LICENSE
```

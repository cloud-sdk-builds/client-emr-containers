...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.631.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.631.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oSMcmtUL9pLCUGlWM4zytldw1aulHoI1mnW5WUqGHelTC7Cdgn6k5tOJ3FHFBycn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.631.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.631.0/index.min.mjs": "sha384-oSMcmtUL9pLCUGlWM4zytldw1aulHoI1mnW5WUqGHelTC7Cdgn6k5tOJ3FHFBycn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.631.0/LICENSE
```

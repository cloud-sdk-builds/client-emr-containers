...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.9.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.9.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WiVTHheLadtLQnbXLKld6AMFoJhUreW0rOrUMPAy6HtzpseLf+HoxXDFjlVz/sfm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.9.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.9.0/index.min.mjs": "sha384-WiVTHheLadtLQnbXLKld6AMFoJhUreW0rOrUMPAy6HtzpseLf+HoxXDFjlVz/sfm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.9.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.430.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.430.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/g1+ZBLz018qUGxG6dc2TlNSyHsdkT0pT9jUTyIrlneR1hSNy5jtA2DK2qxC/ecl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.430.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.430.0/index.min.mjs": "sha384-/g1+ZBLz018qUGxG6dc2TlNSyHsdkT0pT9jUTyIrlneR1hSNy5jtA2DK2qxC/ecl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.430.0/LICENSE
```

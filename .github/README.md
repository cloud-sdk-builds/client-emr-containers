...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MHaAscsDUPLEc6rvLvNR1eu4uZ98zAW+dTHs1MYb343RDqzJEeHXxn5bt+pad1v0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.995.0/index.min.mjs": "sha384-MHaAscsDUPLEc6rvLvNR1eu4uZ98zAW+dTHs1MYb343RDqzJEeHXxn5bt+pad1v0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.995.0/LICENSE
```

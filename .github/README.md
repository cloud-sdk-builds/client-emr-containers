...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r6vd4ytsXTgTsxihxdK6LFSg0MkaMT223s0dOQqLrkEMet/xkJVEQkcInK3f01k3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.413.0/index.min.mjs": "sha384-r6vd4ytsXTgTsxihxdK6LFSg0MkaMT223s0dOQqLrkEMet/xkJVEQkcInK3f01k3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.413.0/LICENSE
```

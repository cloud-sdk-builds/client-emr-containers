...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.582.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.582.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WvVtzHvYQLKVIszwQ01wAdTSYx2Y0dJnAPZgEh0ekk9G7Ig4Qsjaj3sDSxqWcvI2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.582.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.582.0/index.min.mjs": "sha384-WvVtzHvYQLKVIszwQ01wAdTSYx2Y0dJnAPZgEh0ekk9G7Ig4Qsjaj3sDSxqWcvI2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.582.0/LICENSE
```

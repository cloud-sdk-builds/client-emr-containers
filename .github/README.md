...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.883.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.883.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aEWsKoIBgILLxfMFtt313vr6hIXv8uvA+aXEadE68ZblEHLhCKid0MAMpVRDp6s1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.883.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.883.0/index.min.mjs": "sha384-aEWsKoIBgILLxfMFtt313vr6hIXv8uvA+aXEadE68ZblEHLhCKid0MAMpVRDp6s1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.883.0/LICENSE
```

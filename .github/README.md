...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.952.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.952.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UDgBlWoXhUgzN03YFmDd7CKn5hB7ve8tPZyNiLHwlzj5bWRfwri31BuE8SqkqNrY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.952.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.952.0/index.min.mjs": "sha384-UDgBlWoXhUgzN03YFmDd7CKn5hB7ve8tPZyNiLHwlzj5bWRfwri31BuE8SqkqNrY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.952.0/LICENSE
```

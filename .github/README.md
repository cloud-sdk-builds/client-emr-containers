...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.943.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.943.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dMxcWtAmBZxFTlWTJ6X80oq8XJsnQf24mGA5Xw9EzjDaullu6SrzuLHGGDOE7T08
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.943.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.943.0/index.min.mjs": "sha384-dMxcWtAmBZxFTlWTJ6X80oq8XJsnQf24mGA5Xw9EzjDaullu6SrzuLHGGDOE7T08"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.943.0/LICENSE
```

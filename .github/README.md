...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.47.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.47.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-0nQRxmFUmzcgA3nYNI3HumEJGRQG8GN+pakGGDVEzuuM3fxRWTNacF5BsN3VVQqv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.47.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.47.1/index.min.mjs": "sha384-0nQRxmFUmzcgA3nYNI3HumEJGRQG8GN+pakGGDVEzuuM3fxRWTNacF5BsN3VVQqv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.47.1/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.503.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.503.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VgcOrU7nJwFE0UdE7/7e/RauXuyxL2PlpzKxrU6DhTuLjHnq3pNpLH0mRjFO/UoI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.503.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.503.0/index.min.mjs": "sha384-VgcOrU7nJwFE0UdE7/7e/RauXuyxL2PlpzKxrU6DhTuLjHnq3pNpLH0mRjFO/UoI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.503.0/LICENSE
```

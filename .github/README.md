...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.50.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.50.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CS6+AwCqDD61Bo4NIQDbD6N9VUofEIQIvVS/MukdutQ6dDfZ1w+U7ZClY4WhfBZc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.50.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.50.0/index.min.mjs": "sha384-CS6+AwCqDD61Bo4NIQDbD6N9VUofEIQIvVS/MukdutQ6dDfZ1w+U7ZClY4WhfBZc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.50.0/LICENSE
```

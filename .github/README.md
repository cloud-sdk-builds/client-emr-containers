...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.188.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.188.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WgNwG26Oy5Bp5TxXQeJZ61Gou3w/tMLg9dGFAgruCxsHjHIK539dRnUe2Tty/vTc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.188.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.188.0/index.min.mjs": "sha384-WgNwG26Oy5Bp5TxXQeJZ61Gou3w/tMLg9dGFAgruCxsHjHIK539dRnUe2Tty/vTc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.188.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1040.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1040.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Buc26gdbiIRFooEKUGpkl/8QaQvvPFyOGQfUTjRfB0hat7aUYW31YmyoU99zOwVM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1040.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1040.0/index.min.mjs": "sha384-Buc26gdbiIRFooEKUGpkl/8QaQvvPFyOGQfUTjRfB0hat7aUYW31YmyoU99zOwVM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1040.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.398.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.398.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NZhUq31KhhV+hhuMNDPynQ3xuM2BZjaAdZGKBu9Wz4V2AQ4Hc3z7EJqkBLHFqD/w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.398.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.398.0/index.min.mjs": "sha384-NZhUq31KhhV+hhuMNDPynQ3xuM2BZjaAdZGKBu9Wz4V2AQ4Hc3z7EJqkBLHFqD/w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.398.0/LICENSE
```

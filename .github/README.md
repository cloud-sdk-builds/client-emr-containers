...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-efEWmeA0yXbVtsJ/MxsGBs5kxXJnvK/27T41e7Q5rhrZ6+ULThTMTMM2YHOV7ewZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.723.0/index.min.mjs": "sha384-efEWmeA0yXbVtsJ/MxsGBs5kxXJnvK/27T41e7Q5rhrZ6+ULThTMTMM2YHOV7ewZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.723.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e0AnM5Lx4P/dh6lChTwJ/O4PEZeTkqj6e9u6IJIVihDyhp4IqVwJH1mEzMH2Fz2r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.787.0/index.min.mjs": "sha384-e0AnM5Lx4P/dh6lChTwJ/O4PEZeTkqj6e9u6IJIVihDyhp4IqVwJH1mEzMH2Fz2r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.787.0/LICENSE
```

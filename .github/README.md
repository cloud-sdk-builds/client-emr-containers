...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.864.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.864.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uycefWGnlvrY6PZZN5POi3ZnSevQES5b6FDcV1oHBz+XJt/AAdruomOAb090kNf0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.864.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.864.0/index.min.mjs": "sha384-uycefWGnlvrY6PZZN5POi3ZnSevQES5b6FDcV1oHBz+XJt/AAdruomOAb090kNf0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.864.0/LICENSE
```

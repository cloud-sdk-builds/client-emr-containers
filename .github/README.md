...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.79.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.79.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uvyp4ELkPVhNmxd7v58/9KCA3GS9p3h2iXokFUIbdEIIKStc1FoQL+4tK9lLhF6i
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.79.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.79.0/index.min.mjs": "sha384-uvyp4ELkPVhNmxd7v58/9KCA3GS9p3h2iXokFUIbdEIIKStc1FoQL+4tK9lLhF6i"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.79.0/LICENSE
```

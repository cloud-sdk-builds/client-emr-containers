...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.465.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.465.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WTgH8eKXndgAXZlN+hIsHCv+ZIdO7aawU0NMNUYYUMSkX1rZaUkqXbx7l+AHA5+N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.465.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.465.0/index.min.mjs": "sha384-WTgH8eKXndgAXZlN+hIsHCv+ZIdO7aawU0NMNUYYUMSkX1rZaUkqXbx7l+AHA5+N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.465.0/LICENSE
```

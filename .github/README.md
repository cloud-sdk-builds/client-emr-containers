...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YbI53SkI9IFw2u3h3AcuWSyjRiIbByrhSJcJg/hXGVtchk5laL4084ESg+LKpRPp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.994.0/index.min.mjs": "sha384-YbI53SkI9IFw2u3h3AcuWSyjRiIbByrhSJcJg/hXGVtchk5laL4084ESg+LKpRPp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.994.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.749.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.749.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3vT0lBrDe4LepRW8vibK2H4+GgHV0bfeBtfHSDhBG/h30uZ/zrS6awBbApIy8+u9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.749.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.749.0/index.min.mjs": "sha384-3vT0lBrDe4LepRW8vibK2H4+GgHV0bfeBtfHSDhBG/h30uZ/zrS6awBbApIy8+u9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.749.0/LICENSE
```

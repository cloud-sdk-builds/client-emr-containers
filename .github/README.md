...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.797.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.797.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0RInl17q6uaS+tRxO+Bua/eHnC4UNMZwYGRYREb/bbPwsROFpMfs8ocUgzXRpSLZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.797.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.797.0/index.min.mjs": "sha384-0RInl17q6uaS+tRxO+Bua/eHnC4UNMZwYGRYREb/bbPwsROFpMfs8ocUgzXRpSLZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.797.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.782.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.782.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vuJs0FJ0Jpmf9b0MewYLZKbhmir9whRYV/5dHBZ4Z6h1gliAMrgFIHPIayvcdfH0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.782.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.782.0/index.min.mjs": "sha384-vuJs0FJ0Jpmf9b0MewYLZKbhmir9whRYV/5dHBZ4Z6h1gliAMrgFIHPIayvcdfH0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.782.0/LICENSE
```

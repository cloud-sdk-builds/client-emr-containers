...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.958.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.958.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3GEA0WSgTNzTBgBUyGKYcvoD2j7LkLHu0TWbWup5rVPuOvXw/e0DCQVo3acBOPqa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.958.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.958.0/index.min.mjs": "sha384-3GEA0WSgTNzTBgBUyGKYcvoD2j7LkLHu0TWbWup5rVPuOvXw/e0DCQVo3acBOPqa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.958.0/LICENSE
```

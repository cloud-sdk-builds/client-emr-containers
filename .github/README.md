...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.197.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.197.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hzUrLgw4vObDZmacQO0JvPCTOegtstlAsbCrvRfiUX1XEA5epE81FfId+og/0CpT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.197.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.197.0/index.min.mjs": "sha384-hzUrLgw4vObDZmacQO0JvPCTOegtstlAsbCrvRfiUX1XEA5epE81FfId+og/0CpT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.197.0/LICENSE
```

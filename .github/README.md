...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.940.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.940.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7/ny0EvKx/+n3hHxyOhe+C/EVd2CJaIHxsaZ0VCFmwalYfK4ZvPcAsRTQLCHL6uY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.940.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.940.0/index.min.mjs": "sha384-7/ny0EvKx/+n3hHxyOhe+C/EVd2CJaIHxsaZ0VCFmwalYfK4ZvPcAsRTQLCHL6uY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.940.0/LICENSE
```

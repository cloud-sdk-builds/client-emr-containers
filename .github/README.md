...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.348.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.348.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JN7aXEqQa+7uDx1a+GFozN5Zi+B09ADzPb6jA5lcQJe3chMbUxeR/RdTXtYvdAAH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.348.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.348.0/index.min.mjs": "sha384-JN7aXEqQa+7uDx1a+GFozN5Zi+B09ADzPb6jA5lcQJe3chMbUxeR/RdTXtYvdAAH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.348.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.36.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.36.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-0nMo8TjCa5y1lB6IPeQSEhxneJfgiFSjxbV4/dQ+tAWv/Hb2YWI+PlrdRjnrIJoX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.36.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.36.1/index.min.mjs": "sha384-0nMo8TjCa5y1lB6IPeQSEhxneJfgiFSjxbV4/dQ+tAWv/Hb2YWI+PlrdRjnrIJoX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.36.1/LICENSE
```

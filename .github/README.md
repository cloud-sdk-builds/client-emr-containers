...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FEpSENzhPGQUz2T+qDVMT6JVuY28xibFFR4USPiDkcQf8zXOmPd/8eP70lGa+iW+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.999.0/index.min.mjs": "sha384-FEpSENzhPGQUz2T+qDVMT6JVuY28xibFFR4USPiDkcQf8zXOmPd/8eP70lGa+iW+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.999.0/LICENSE
```

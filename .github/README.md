...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.20.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.20.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZkjBUoPhvCWOBQ6AfbsYwCbWgDGOfHjVQVhFV0aBiCaA+7Nf3JARIvhyMwpRr3OI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.20.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.20.0/index.min.mjs": "sha384-ZkjBUoPhvCWOBQ6AfbsYwCbWgDGOfHjVQVhFV0aBiCaA+7Nf3JARIvhyMwpRr3OI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.20.0/LICENSE
```

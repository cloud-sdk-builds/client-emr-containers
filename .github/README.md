...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1023.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1023.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GtMU8mRtH3iBY/VSCYWmCzufpEs6Fvfw0ySFd2YNO9RVH7nzJgRgCJoJSHyPc8El
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1023.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1023.0/index.min.mjs": "sha384-GtMU8mRtH3iBY/VSCYWmCzufpEs6Fvfw0ySFd2YNO9RVH7nzJgRgCJoJSHyPc8El"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1023.0/LICENSE
```

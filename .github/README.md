...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.523.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.523.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zHxXRzpjb/L6UlqRKae7ftOWKpeuQzWD7qJqBVWoRgttOsL+Qx2gUr7D+XHv7oER
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.523.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.523.0/index.min.mjs": "sha384-zHxXRzpjb/L6UlqRKae7ftOWKpeuQzWD7qJqBVWoRgttOsL+Qx2gUr7D+XHv7oER"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.523.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HvF+QTl5WQ8ZOZPiZeeUbeE1JP37bESUgcVqHQ8nucj5MiIyFIriAluZW0UA+kZb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.649.0/index.min.mjs": "sha384-HvF+QTl5WQ8ZOZPiZeeUbeE1JP37bESUgcVqHQ8nucj5MiIyFIriAluZW0UA+kZb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.649.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.212.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.212.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wwo2M5qqGeWtcCD6KSYJoUQin5cRyW1866rp/irbMnzvirgW/sxtTKXnugvMARsV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.212.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.212.0/index.min.mjs": "sha384-wwo2M5qqGeWtcCD6KSYJoUQin5cRyW1866rp/irbMnzvirgW/sxtTKXnugvMARsV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.212.0/LICENSE
```

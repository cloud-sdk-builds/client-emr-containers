...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.418.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.418.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3yTF/1ls6WvS25Yn+yXpYaPFc+JsnqYTXlF45BmBgnWnA9mPxvp/nn05NFZgmQoF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.418.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.418.0/index.min.mjs": "sha384-3yTF/1ls6WvS25Yn+yXpYaPFc+JsnqYTXlF45BmBgnWnA9mPxvp/nn05NFZgmQoF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.418.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.674.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.674.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mgLnsbL1mFcnZCAOr0sUL5Ey57RZ+QjG3vMfns8TK7QQMvPyg3AhKv8cwrcXqSjI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.674.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.674.0/index.min.mjs": "sha384-mgLnsbL1mFcnZCAOr0sUL5Ey57RZ+QjG3vMfns8TK7QQMvPyg3AhKv8cwrcXqSjI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.674.0/LICENSE
```

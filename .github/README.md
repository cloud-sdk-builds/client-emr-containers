...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.7.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.7.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AkKzajg4QuBmqhO06srxeB2WFd1yjBX5fet3oQ5nhqhMKEl4SFToBF/9/+2R8gXn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.7.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.7.0/index.min.mjs": "sha384-AkKzajg4QuBmqhO06srxeB2WFd1yjBX5fet3oQ5nhqhMKEl4SFToBF/9/+2R8gXn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.7.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.629.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.629.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BllCgJyLKLCXE3Z3GH/bd8Duv9hcL8y77Vh/hp0XntELHcPczVIKt9w63i0nkRTi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.629.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.629.0/index.min.mjs": "sha384-BllCgJyLKLCXE3Z3GH/bd8Duv9hcL8y77Vh/hp0XntELHcPczVIKt9w63i0nkRTi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.629.0/LICENSE
```

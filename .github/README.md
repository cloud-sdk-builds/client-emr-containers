...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.535.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.535.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Mv5hHc2P4zYYJ2B939gtEEEQH8RTJJzMbdoXlshM8OXGinNGhdj4qfS2Jv1mPqJn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.535.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.535.0/index.min.mjs": "sha384-Mv5hHc2P4zYYJ2B939gtEEEQH8RTJJzMbdoXlshM8OXGinNGhdj4qfS2Jv1mPqJn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.535.0/LICENSE
```

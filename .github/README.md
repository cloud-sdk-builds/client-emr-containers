...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yEF3sxBy4mlvy1K0+bJy2KYlHbKXJbM4ZQpIoX/cxsOkUA7pmrdJvnjK1SQKPNwW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.775.0/index.min.mjs": "sha384-yEF3sxBy4mlvy1K0+bJy2KYlHbKXJbM4ZQpIoX/cxsOkUA7pmrdJvnjK1SQKPNwW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.775.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.654.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.654.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gYYqu25inIbfgi3nSUa1/oNP9qKAJ3DsS6zW08bEVArfgvL2cIzdDhkioTrNRcUI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.654.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.654.0/index.min.mjs": "sha384-gYYqu25inIbfgi3nSUa1/oNP9qKAJ3DsS6zW08bEVArfgvL2cIzdDhkioTrNRcUI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.654.0/LICENSE
```

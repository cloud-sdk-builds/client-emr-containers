...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.325.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.325.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JHsSbU+S6NMOIE600bsWJETc33lCzHqyt9x+Y03bjGHuv21ec3DF22Dui4KjIRPm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.325.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.325.0/index.min.mjs": "sha384-JHsSbU+S6NMOIE600bsWJETc33lCzHqyt9x+Y03bjGHuv21ec3DF22Dui4KjIRPm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.325.0/LICENSE
```

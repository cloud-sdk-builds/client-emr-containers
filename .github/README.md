...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kklVsT6PfCmWNzUMBT3NKuyvf2BDpT87x3x5JhpshstXHcnlj+GJzAu0SQYqzPmO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.965.0/index.min.mjs": "sha384-kklVsT6PfCmWNzUMBT3NKuyvf2BDpT87x3x5JhpshstXHcnlj+GJzAu0SQYqzPmO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.965.0/LICENSE
```

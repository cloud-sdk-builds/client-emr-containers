...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.28.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.28.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Dki0t/IJW82X4knowHQ3vvOLKrF9Ymd0iiVJGddPSHx/MnXEwT3MXkGZS+eg/ktG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.28.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.28.0/index.min.mjs": "sha384-Dki0t/IJW82X4knowHQ3vvOLKrF9Ymd0iiVJGddPSHx/MnXEwT3MXkGZS+eg/ktG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.28.0/LICENSE
```

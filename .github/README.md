...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.276.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.276.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6udNPrhzFC1xb4f+I1Nqe6d6ZILpsXloToECNxG/Ym/+KHCMLgpOwy/av3eLIsRj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.276.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.276.0/index.min.mjs": "sha384-6udNPrhzFC1xb4f+I1Nqe6d6ZILpsXloToECNxG/Ym/+KHCMLgpOwy/av3eLIsRj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.276.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.609.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.609.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OLa4RvDROb5BNXUgrX4RoB9aS2HpPYrww1891AC1HxAjrF8OapUyTNGQIfhNgyfv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.609.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.609.0/index.min.mjs": "sha384-OLa4RvDROb5BNXUgrX4RoB9aS2HpPYrww1891AC1HxAjrF8OapUyTNGQIfhNgyfv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.609.0/LICENSE
```

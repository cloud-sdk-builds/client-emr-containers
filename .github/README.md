...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kZEbyfeuqJNKDtimIvwXGHEEy25nB4sDrFO4vac0xI4lbaN9Oe4v+9A+BB83lMju
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.55.0/index.min.mjs": "sha384-kZEbyfeuqJNKDtimIvwXGHEEy25nB4sDrFO4vac0xI4lbaN9Oe4v+9A+BB83lMju"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.55.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1009.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1009.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ugf9nWnjkHjSWJZt/KLeIugBTNL/P71s5LEvJqyV/XQHuy9jDbOTHgVSHsWpftIm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1009.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1009.0/index.min.mjs": "sha384-Ugf9nWnjkHjSWJZt/KLeIugBTNL/P71s5LEvJqyV/XQHuy9jDbOTHgVSHsWpftIm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1009.0/LICENSE
```

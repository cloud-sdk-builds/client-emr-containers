...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.257.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.257.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vt5pOJd4NxCCUHfKABJ5IABy7pUlwvitVmxs9pd5ahYFdMH1HhtTFv0guJji+q4i
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.257.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.257.0/index.min.mjs": "sha384-vt5pOJd4NxCCUHfKABJ5IABy7pUlwvitVmxs9pd5ahYFdMH1HhtTFv0guJji+q4i"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.257.0/LICENSE
```

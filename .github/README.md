...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.258.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.258.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8eiRKuUuFhnrE7y2NnNutU9Bc5AZhSG/kiC1W1kwFwiU4J/7jIPtDg7jyMiiH7nR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.258.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.258.0/index.min.mjs": "sha384-8eiRKuUuFhnrE7y2NnNutU9Bc5AZhSG/kiC1W1kwFwiU4J/7jIPtDg7jyMiiH7nR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.258.0/LICENSE
```

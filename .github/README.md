...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.137.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.137.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xpMdf+q+dzlDQOhuRaoYA7evO/g5WMESfL1P92Goj9Am6FaTo6RkmNvMZUChfu8H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.137.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.137.0/index.min.mjs": "sha384-xpMdf+q+dzlDQOhuRaoYA7evO/g5WMESfL1P92Goj9Am6FaTo6RkmNvMZUChfu8H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.137.0/LICENSE
```

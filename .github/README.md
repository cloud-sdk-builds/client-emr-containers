...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.17.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.17.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xOMMghxaOia1MsR/gnLHICM6pH7PPq+qvELrYh2JcX8MsbDkurmHab3w2U1Y3A2L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.17.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.17.0/index.min.mjs": "sha384-xOMMghxaOia1MsR/gnLHICM6pH7PPq+qvELrYh2JcX8MsbDkurmHab3w2U1Y3A2L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.17.0/LICENSE
```

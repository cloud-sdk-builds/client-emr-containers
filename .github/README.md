...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.303.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.303.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OENEKTStoVD1x8Pi4g8aU5x/WziXFbfhwYd2XjCUqNbRG/6VzAZFRmqrtM8rGXRh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.303.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.303.0/index.min.mjs": "sha384-OENEKTStoVD1x8Pi4g8aU5x/WziXFbfhwYd2XjCUqNbRG/6VzAZFRmqrtM8rGXRh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.303.0/LICENSE
```

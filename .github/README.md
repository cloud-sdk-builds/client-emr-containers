...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.429.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.429.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o4uveJw7oIitn2wqy0NWuzmpxPGvvI5ruhQJgoq9k5cxzXmFc6ULRtjS4IxDBFBP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.429.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.429.0/index.min.mjs": "sha384-o4uveJw7oIitn2wqy0NWuzmpxPGvvI5ruhQJgoq9k5cxzXmFc6ULRtjS4IxDBFBP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.429.0/LICENSE
```

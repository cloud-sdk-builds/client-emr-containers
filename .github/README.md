...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1000.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1000.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0rTbXMLxB4KPGnfBR+sGhgc1RSzqQk5UDF4W1TTELoX+p1vjA6RuorWHs3p/pFWt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1000.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1000.0/index.min.mjs": "sha384-0rTbXMLxB4KPGnfBR+sGhgc1RSzqQk5UDF4W1TTELoX+p1vjA6RuorWHs3p/pFWt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1000.0/LICENSE
```

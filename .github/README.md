...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.12.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.12.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a6i8z2gOsiwa84Skuhhzh/2G7x+25fOE7/aFJ7q+eXHKEjScLG6hM3jSEDRc66fg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.12.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.12.0/index.min.mjs": "sha384-a6i8z2gOsiwa84Skuhhzh/2G7x+25fOE7/aFJ7q+eXHKEjScLG6hM3jSEDRc66fg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.12.0/LICENSE
```

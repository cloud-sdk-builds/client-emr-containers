...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.337.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.337.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qwYqYcYjzE4vQ1A4zexS76Cih40xeLoQNCYZv2X1ltlllM1hKHQP6WUCyVBYtq6Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.337.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.337.0/index.min.mjs": "sha384-qwYqYcYjzE4vQ1A4zexS76Cih40xeLoQNCYZv2X1ltlllM1hKHQP6WUCyVBYtq6Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.337.0/LICENSE
```

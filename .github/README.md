...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.226.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.226.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QYQsYwmKbtMUm+nfqt7dQ3uJt5TIhuJnUJQGC7d1IL9a+Ap8EF5HarLSKyirfbtJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.226.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.226.0/index.min.mjs": "sha384-QYQsYwmKbtMUm+nfqt7dQ3uJt5TIhuJnUJQGC7d1IL9a+Ap8EF5HarLSKyirfbtJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.226.0/LICENSE
```

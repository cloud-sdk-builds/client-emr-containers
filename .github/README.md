...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.451.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.451.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mOp80CX9PfnuOFAbeep263sPYjD1R1pZY2XsCh4j0qqZ6tqIa6AJvkfnN1p056EO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.451.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.451.0/index.min.mjs": "sha384-mOp80CX9PfnuOFAbeep263sPYjD1R1pZY2XsCh4j0qqZ6tqIa6AJvkfnN1p056EO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.451.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.577.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.577.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DCESJjOxfRS3W5NNLDudaLQ7QO/eMbuef1xEZYKLN5NiHuV5AWl/ZxaWbnJXSRFi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.577.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.577.0/index.min.mjs": "sha384-DCESJjOxfRS3W5NNLDudaLQ7QO/eMbuef1xEZYKLN5NiHuV5AWl/ZxaWbnJXSRFi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.577.0/LICENSE
```

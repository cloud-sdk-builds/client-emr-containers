...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.988.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.988.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RzBA0P+wNzghS/ytOKHiwSEBuCG38g+s/Dx9cztTMn518b4hfvDbA1H9YZLD+OwT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.988.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.988.0/index.min.mjs": "sha384-RzBA0P+wNzghS/ytOKHiwSEBuCG38g+s/Dx9cztTMn518b4hfvDbA1H9YZLD+OwT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.988.0/LICENSE
```

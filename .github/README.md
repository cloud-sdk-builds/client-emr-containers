...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.918.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.918.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6d4cc5QBzGawfSG6A7B20+Qme4T/bEvGYplx/CtZJDLN4NhrXXSLSKCll2vc0tFv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.918.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.918.0/index.min.mjs": "sha384-6d4cc5QBzGawfSG6A7B20+Qme4T/bEvGYplx/CtZJDLN4NhrXXSLSKCll2vc0tFv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.918.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.190.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.190.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tVLpuGZ/Bik3rPrFeCenUY3Ub1vDQhym2apAiEgi/1CrAnlNiGCIjm6+lAvYGzC/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.190.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.190.0/index.min.mjs": "sha384-tVLpuGZ/Bik3rPrFeCenUY3Ub1vDQhym2apAiEgi/1CrAnlNiGCIjm6+lAvYGzC/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.190.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.569.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.569.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WsRYRh0r6ube4EEfo8GCvn2bkEI1EERA56HK/hZOnf1VdTCQqJXeCBEMHccucKQ8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.569.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.569.0/index.min.mjs": "sha384-WsRYRh0r6ube4EEfo8GCvn2bkEI1EERA56HK/hZOnf1VdTCQqJXeCBEMHccucKQ8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.569.0/LICENSE
```

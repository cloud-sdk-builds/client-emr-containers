...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.691.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.691.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+QcCqnlpNsjiM4SI5mieVQzAiCD11TjFOb6PNkWqMnRVOD+cMmgO4iRdT+MZgwt5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.691.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.691.0/index.min.mjs": "sha384-+QcCqnlpNsjiM4SI5mieVQzAiCD11TjFOb6PNkWqMnRVOD+cMmgO4iRdT+MZgwt5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.691.0/LICENSE
```

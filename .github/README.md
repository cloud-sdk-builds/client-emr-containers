...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.385.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.385.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-U1Tp1ejXdAb53twBnCz3aubfiIsw86FSsyIcOJBNbaPjAHJK3JJ3NaVJ7QPqxTwo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.385.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.385.0/index.min.mjs": "sha384-U1Tp1ejXdAb53twBnCz3aubfiIsw86FSsyIcOJBNbaPjAHJK3JJ3NaVJ7QPqxTwo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.385.0/LICENSE
```

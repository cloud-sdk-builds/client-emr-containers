...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.29.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.29.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DFgMhzFaNiVhlKth7FR51H9PrQZfIprzT83a0Cc7Jr3ILF2M9MAfVNDBVaiJ+xuQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.29.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.29.0/index.min.mjs": "sha384-DFgMhzFaNiVhlKth7FR51H9PrQZfIprzT83a0Cc7Jr3ILF2M9MAfVNDBVaiJ+xuQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.29.0/LICENSE
```

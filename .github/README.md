...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aiCxadUJ3D6thOY/60x4Hf/v+lGsi9NnfoLDdPBYIVz5qUBPD9DlpuEiUEIOqUTU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.846.0/index.min.mjs": "sha384-aiCxadUJ3D6thOY/60x4Hf/v+lGsi9NnfoLDdPBYIVz5qUBPD9DlpuEiUEIOqUTU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.846.0/LICENSE
```

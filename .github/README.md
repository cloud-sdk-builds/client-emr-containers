...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.946.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.946.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AWnJkEgMOvVW5yFd5acjgqMnKa1T2syq8I5SmnizwflGpYyKJ78yIfdN2DGNNC5D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.946.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.946.0/index.min.mjs": "sha384-AWnJkEgMOvVW5yFd5acjgqMnKa1T2syq8I5SmnizwflGpYyKJ78yIfdN2DGNNC5D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.946.0/LICENSE
```

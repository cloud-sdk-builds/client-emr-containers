...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.929.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.929.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OMLCvp8lVR60ZmFDsc7OV6gTPKhjpo807pK4veCDR9NK/Qhlfh+jfxrEy5sZgfOI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.929.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.929.0/index.min.mjs": "sha384-OMLCvp8lVR60ZmFDsc7OV6gTPKhjpo807pK4veCDR9NK/Qhlfh+jfxrEy5sZgfOI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.929.0/LICENSE
```

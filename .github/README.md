...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.33.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.33.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6X5LY/u1lt+FpunGs+3o14bdyaZedAWSXqlySXRHc63Xl3gH/V1WppZ9OuaXw0QE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.33.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.33.0/index.min.mjs": "sha384-6X5LY/u1lt+FpunGs+3o14bdyaZedAWSXqlySXRHc63Xl3gH/V1WppZ9OuaXw0QE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.33.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.21.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.21.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mCRf5BPGZBds0nt2SAgJcAu46MX31bmaltSasWsv+T/fxDdNrCeCZq53+r8WJdfR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.21.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.21.0/index.min.mjs": "sha384-mCRf5BPGZBds0nt2SAgJcAu46MX31bmaltSasWsv+T/fxDdNrCeCZq53+r8WJdfR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.21.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.431.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.431.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DCl9Y+puJfxuPgb4qwtNIkguo70P75dLqbDTBw1I8fGU8kpZ3YKhsGib+F47paWQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.431.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.431.0/index.min.mjs": "sha384-DCl9Y+puJfxuPgb4qwtNIkguo70P75dLqbDTBw1I8fGU8kpZ3YKhsGib+F47paWQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.431.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G92TneeM4robgZdt3x+G8JAKE9gB93DiWoisOLDIf4nGFRAN1dyTtS3Xw3OBNwMQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.911.0/index.min.mjs": "sha384-G92TneeM4robgZdt3x+G8JAKE9gB93DiWoisOLDIf4nGFRAN1dyTtS3Xw3OBNwMQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.911.0/LICENSE
```

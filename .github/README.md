...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.650.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t8Mte28eLji7cIYREhyubTARKJVwp+WM11GsM7KInffMHr0Te3rP1OeFB0j/aap0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.650.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.650.0/index.min.mjs": "sha384-t8Mte28eLji7cIYREhyubTARKJVwp+WM11GsM7KInffMHr0Te3rP1OeFB0j/aap0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.650.0/LICENSE
```

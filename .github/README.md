...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1002.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1002.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-//LrRBJcW7bYONMvOtNHNh1KKAvBAP3rZW2vv4PjD9yiPxAt+bDMzIa+DFAaLWP2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1002.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1002.0/index.min.mjs": "sha384-//LrRBJcW7bYONMvOtNHNh1KKAvBAP3rZW2vv4PjD9yiPxAt+bDMzIa+DFAaLWP2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1002.0/LICENSE
```

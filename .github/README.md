...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ow7haEVPdoYJ51MGWM41UvPovq11Lppkhh9POh7yQTG42fesv0gMCdWzfzRPwZtS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.906.0/index.min.mjs": "sha384-ow7haEVPdoYJ51MGWM41UvPovq11Lppkhh9POh7yQTG42fesv0gMCdWzfzRPwZtS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.906.0/LICENSE
```

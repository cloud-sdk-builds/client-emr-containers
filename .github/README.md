...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.335.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.335.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MJLKPXAcc5rvKqlw1jAuk7eNuB24S9Q8/hieks0FVqcrFDjGSImd9jMwsQmpERtF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.335.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.335.0/index.min.mjs": "sha384-MJLKPXAcc5rvKqlw1jAuk7eNuB24S9Q8/hieks0FVqcrFDjGSImd9jMwsQmpERtF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.335.0/LICENSE
```

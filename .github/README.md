...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.31.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.31.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wCyI8gH9z7PioNzdxu8le7UgHlfcHIIeZEI81bSle9ofyjXH5+BwRvwWtGRAD9t/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.31.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.31.0/index.min.mjs": "sha384-wCyI8gH9z7PioNzdxu8le7UgHlfcHIIeZEI81bSle9ofyjXH5+BwRvwWtGRAD9t/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.31.0/LICENSE
```

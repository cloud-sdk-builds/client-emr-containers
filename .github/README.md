...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1032.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1032.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rH3+M4NA7rIrrjolyT5v+daoyiaf7QSs4HzmymeNCdDhSZWNc41Ji1DmPThSIY6y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1032.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1032.0/index.min.mjs": "sha384-rH3+M4NA7rIrrjolyT5v+daoyiaf7QSs4HzmymeNCdDhSZWNc41Ji1DmPThSIY6y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1032.0/LICENSE
```

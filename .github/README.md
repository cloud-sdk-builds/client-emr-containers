...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1034.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1034.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IBNQgLGid+OVjpaiGi0eXZ+LxofI/mmSNz0tSBOGo67Z7miYvqOox9PZ8K6Ec99q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1034.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1034.0/index.min.mjs": "sha384-IBNQgLGid+OVjpaiGi0eXZ+LxofI/mmSNz0tSBOGo67Z7miYvqOox9PZ8K6Ec99q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1034.0/LICENSE
```

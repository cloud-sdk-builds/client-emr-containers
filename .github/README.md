...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.378.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.378.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ywT0q2aQRNmYSkfQDjTj7OhCY0rNX1jPGunrWhzT0ZyECuVUbyEuFvVBOr8pzU7a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.378.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.378.0/index.min.mjs": "sha384-ywT0q2aQRNmYSkfQDjTj7OhCY0rNX1jPGunrWhzT0ZyECuVUbyEuFvVBOr8pzU7a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.378.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.901.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.901.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hlcZ0FE7ZEt1QdhdYWfVNC5JADllMDB/NGgSOfbeG61jehH7Zwcw+GH3zzEcPzWt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.901.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.901.0/index.min.mjs": "sha384-hlcZ0FE7ZEt1QdhdYWfVNC5JADllMDB/NGgSOfbeG61jehH7Zwcw+GH3zzEcPzWt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.901.0/LICENSE
```

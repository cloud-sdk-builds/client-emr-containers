...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Dca3IpvkO78925fdRiZkExLz+s0ECNKXAnpkauEcq/cxL+tsYcRr0+4JqLGHFTqv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.503.1/index.min.mjs": "sha384-Dca3IpvkO78925fdRiZkExLz+s0ECNKXAnpkauEcq/cxL+tsYcRr0+4JqLGHFTqv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.503.1/LICENSE
```

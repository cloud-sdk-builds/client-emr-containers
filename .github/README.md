...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.931.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.931.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C5nLLbEU6hI4vpJ0UMLrzgOV5v4hgeQwlT/k8pi0/Svvcq0vqIjLt5Ms41nlx3th
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.931.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.931.0/index.min.mjs": "sha384-C5nLLbEU6hI4vpJ0UMLrzgOV5v4hgeQwlT/k8pi0/Svvcq0vqIjLt5Ms41nlx3th"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.931.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MHkpp0etcfPAPX7nUVvAWv6RDwPAIBpgNLkz0CMB/ESsJfs5iGGHd5hsCZVqEHfJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.926.0/index.min.mjs": "sha384-MHkpp0etcfPAPX7nUVvAWv6RDwPAIBpgNLkz0CMB/ESsJfs5iGGHd5hsCZVqEHfJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.926.0/LICENSE
```

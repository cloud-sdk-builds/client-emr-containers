...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.821.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.821.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uGgXsNSFIwNF+lD+ERWxdUuO1QDcX8RBvmtdJGqvSVSmbBT3aRXDuI86JDYKFT0W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.821.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.821.0/index.min.mjs": "sha384-uGgXsNSFIwNF+lD+ERWxdUuO1QDcX8RBvmtdJGqvSVSmbBT3aRXDuI86JDYKFT0W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.821.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.712.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.712.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kyGwyMtEoqlPs3SIuRoNR0A3tyD3Dxu50urUFQBvp3TcqkW73x0NM9x4OlRAU0lR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.712.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.712.0/index.min.mjs": "sha384-kyGwyMtEoqlPs3SIuRoNR0A3tyD3Dxu50urUFQBvp3TcqkW73x0NM9x4OlRAU0lR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.712.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.825.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.825.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SAyaQ4kM+ONgx9WgRgTbzqeujX0aHIcn03PB5L1B374diT/0W2n7T3jFc74WwYvd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.825.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.825.0/index.min.mjs": "sha384-SAyaQ4kM+ONgx9WgRgTbzqeujX0aHIcn03PB5L1B374diT/0W2n7T3jFc74WwYvd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.825.0/LICENSE
```

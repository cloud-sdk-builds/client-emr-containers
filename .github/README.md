...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.179.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.179.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CMbdy68ue+KymSiaI9CdpzXuNl8lqs0nyDF36BcrNWutPZ5zSr26N607HeF8h02B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.179.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.179.0/index.min.mjs": "sha384-CMbdy68ue+KymSiaI9CdpzXuNl8lqs0nyDF36BcrNWutPZ5zSr26N607HeF8h02B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.179.0/LICENSE
```

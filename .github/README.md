...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AOR1O4dRZ5IcWEnW6bvmTdehy6T8PvtONvj4/Vsc2B25R+zJYPD8uHvtaG0Ko0yy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.777.0/index.min.mjs": "sha384-AOR1O4dRZ5IcWEnW6bvmTdehy6T8PvtONvj4/Vsc2B25R+zJYPD8uHvtaG0Ko0yy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.777.0/LICENSE
```

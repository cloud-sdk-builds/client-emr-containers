...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.252.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.252.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n7yNRDsCk+8xJhJUBscTzfe+Fiw89z2EXfTPkYhy/8PhrUrjgqYx3GMgfunTr2/9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.252.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.252.0/index.min.mjs": "sha384-n7yNRDsCk+8xJhJUBscTzfe+Fiw89z2EXfTPkYhy/8PhrUrjgqYx3GMgfunTr2/9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.252.0/LICENSE
```

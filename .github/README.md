...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.145.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.145.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NjJyb16LN8vWwL2ocq5W9qZp2UM8Y7Xitlujw6tchyBXXyn2YlXDKqQxUFcnPmzO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.145.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.145.0/index.min.mjs": "sha384-NjJyb16LN8vWwL2ocq5W9qZp2UM8Y7Xitlujw6tchyBXXyn2YlXDKqQxUFcnPmzO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.145.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NZangCeHsKmZ4UyL/GcdmMwwAaeBg36z4g2IFTD6ShaWgNElEhtlulLgmrfxwVse
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.859.0/index.min.mjs": "sha384-NZangCeHsKmZ4UyL/GcdmMwwAaeBg36z4g2IFTD6ShaWgNElEhtlulLgmrfxwVse"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.859.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.521.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.521.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4LpBQRrXyPJdWd3z/l3ls1ID7dgr5Wfw75BUX06elujjLim9SQixq4Ln+JF1VIk3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.521.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.521.0/index.min.mjs": "sha384-4LpBQRrXyPJdWd3z/l3ls1ID7dgr5Wfw75BUX06elujjLim9SQixq4Ln+JF1VIk3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.521.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.478.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.478.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hmuRPm0cdj+Mjgso8tZBRzATCVaIuBPQYXQ05ir2BB5E4nYnBVvYvN9DLFcCSlnW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.478.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.478.0/index.min.mjs": "sha384-hmuRPm0cdj+Mjgso8tZBRzATCVaIuBPQYXQ05ir2BB5E4nYnBVvYvN9DLFcCSlnW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.478.0/LICENSE
```

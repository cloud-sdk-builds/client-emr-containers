...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.26.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.26.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MC/7T5irn5YNQdSOSha9No7A76wst7FjL2M0QL/5s8Ms8WDrIt35ETKxZyK//5JD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.26.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.26.0/index.min.mjs": "sha384-MC/7T5irn5YNQdSOSha9No7A76wst7FjL2M0QL/5s8Ms8WDrIt35ETKxZyK//5JD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.26.0/LICENSE
```

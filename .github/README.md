...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w+UAlhe8cYSY+SsMDLH4Rr1NorK1s2RhkjnBZG99UPT5u2i2xWPyoXZj69RbhoBG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.890.0/index.min.mjs": "sha384-w+UAlhe8cYSY+SsMDLH4Rr1NorK1s2RhkjnBZG99UPT5u2i2xWPyoXZj69RbhoBG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.890.0/LICENSE
```

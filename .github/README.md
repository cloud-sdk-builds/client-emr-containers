...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8lPOsdTdG86FdgI7ZUmWm5mccZo4aI14nvpXwXjF2MCh+aGB999tOQCqDXD8D7zL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.993.0/index.min.mjs": "sha384-8lPOsdTdG86FdgI7ZUmWm5mccZo4aI14nvpXwXjF2MCh+aGB999tOQCqDXD8D7zL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.993.0/LICENSE
```

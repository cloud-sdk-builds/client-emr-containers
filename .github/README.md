...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.357.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.357.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dZcHrGEQx2nvzEUnR8lXCGFRN2Ph+Z2rfIZi2xqRXEq76jBHqKyEL3b+K9A5sOJ6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.357.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.357.0/index.min.mjs": "sha384-dZcHrGEQx2nvzEUnR8lXCGFRN2Ph+Z2rfIZi2xqRXEq76jBHqKyEL3b+K9A5sOJ6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.357.0/LICENSE
```

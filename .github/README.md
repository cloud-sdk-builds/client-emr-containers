...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.281.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.281.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bWZIvilzKu3Y16qmtYGuoyNLT3RlgCho74KJ/p2qZBHMFbvy54lv2tOsjIRg5N5P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.281.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.281.0/index.min.mjs": "sha384-bWZIvilzKu3Y16qmtYGuoyNLT3RlgCho74KJ/p2qZBHMFbvy54lv2tOsjIRg5N5P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.281.0/LICENSE
```

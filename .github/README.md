...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.92.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.92.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x3nzSQDV3O1SPpWjSCWWI/uK/WS0qtiDBSmlfAZlhzgjACOlx0UBLqG4mnBC6HQO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.92.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.92.0/index.min.mjs": "sha384-x3nzSQDV3O1SPpWjSCWWI/uK/WS0qtiDBSmlfAZlhzgjACOlx0UBLqG4mnBC6HQO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.92.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.914.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.914.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6ASXBUGrt+gE/yN9WXiHLojqMS3os47lW3sPvsVz8v0C4SjfiK1BQU/8m0CLlIcY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.914.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.914.0/index.min.mjs": "sha384-6ASXBUGrt+gE/yN9WXiHLojqMS3os47lW3sPvsVz8v0C4SjfiK1BQU/8m0CLlIcY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.914.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.328.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.328.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+r14ZopdpzWzy9pRygSeMdwVaN+h1joAop/U0AhhKJIsG8jRStFHvijWB2oMzgT6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.328.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.328.0/index.min.mjs": "sha384-+r14ZopdpzWzy9pRygSeMdwVaN+h1joAop/U0AhhKJIsG8jRStFHvijWB2oMzgT6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.328.0/LICENSE
```

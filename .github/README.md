...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LZh76/ALWaOK+ERw1E5XWxgfONvOaIKOrCPUJCmKoSwv4D6uwhhmjWbXjE5po87V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.744.0/index.min.mjs": "sha384-LZh76/ALWaOK+ERw1E5XWxgfONvOaIKOrCPUJCmKoSwv4D6uwhhmjWbXjE5po87V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.744.0/LICENSE
```

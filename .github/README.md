...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.382.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.382.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xxy6y0y7qQGy8kL1oMKydQKUmi1dKB69kllNtpVp3ymRh7epxPwuX8JYy9izbMDy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.382.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.382.0/index.min.mjs": "sha384-Xxy6y0y7qQGy8kL1oMKydQKUmi1dKB69kllNtpVp3ymRh7epxPwuX8JYy9izbMDy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.382.0/LICENSE
```

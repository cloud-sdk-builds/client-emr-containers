...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mz5zJGVLS9zQNaA2mWQmYuPk7p5I4z4mS9W/IxcLajdQJ9B6lH+fNHOOj8N36ibA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.677.0/index.min.mjs": "sha384-mz5zJGVLS9zQNaA2mWQmYuPk7p5I4z4mS9W/IxcLajdQJ9B6lH+fNHOOj8N36ibA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.677.0/LICENSE
```

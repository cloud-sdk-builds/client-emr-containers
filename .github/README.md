...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B36De8mvp3MgTi8YJD3mLbZMmw0DPuDFbE0E4hHXzEshtvHGBebyqL+z0VsjvgRQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.848.0/index.min.mjs": "sha384-B36De8mvp3MgTi8YJD3mLbZMmw0DPuDFbE0E4hHXzEshtvHGBebyqL+z0VsjvgRQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.848.0/LICENSE
```

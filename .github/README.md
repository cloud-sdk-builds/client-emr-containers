...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rN6ixt8r/t5H7z1GHgcHRuYFR1fYAbifRuAI6DQv3by1zomjmgzpNXUmi2S1p9r7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1.0/index.min.mjs": "sha384-rN6ixt8r/t5H7z1GHgcHRuYFR1fYAbifRuAI6DQv3by1zomjmgzpNXUmi2S1p9r7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1.0/LICENSE
```

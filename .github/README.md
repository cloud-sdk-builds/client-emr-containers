...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1003.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1003.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LmfGN/WNXLu2b2n12kQ1goYPRqaOcGA9oEBGoPdswo+ahNDRiiTEMY8gF7kOje7m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1003.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1003.0/index.min.mjs": "sha384-LmfGN/WNXLu2b2n12kQ1goYPRqaOcGA9oEBGoPdswo+ahNDRiiTEMY8gF7kOje7m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1003.0/LICENSE
```

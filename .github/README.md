...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dn3DSZb5f+pFqk5Fli5w0FSrBglmqG/H+QNqO/8acAWjVF7kuMdEqnK5JjU30zlJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.921.0/index.min.mjs": "sha384-dn3DSZb5f+pFqk5Fli5w0FSrBglmqG/H+QNqO/8acAWjVF7kuMdEqnK5JjU30zlJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.921.0/LICENSE
```

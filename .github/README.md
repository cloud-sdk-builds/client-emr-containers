...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nFD6E3MyFvptopeInBeYXFHwsYlOpfckQ7V0v6JFWI0j5kCx981MRE2Ew+fbsTL2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.254.0/index.min.mjs": "sha384-nFD6E3MyFvptopeInBeYXFHwsYlOpfckQ7V0v6JFWI0j5kCx981MRE2Ew+fbsTL2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.254.0/LICENSE
```

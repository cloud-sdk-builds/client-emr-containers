...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.895.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.895.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mAPSf8kwmTnVH8fGCDBCZl2e3ihUI9Nrdue4h4PGL5wC93r5MaTUpSLE29ZIpPDh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.895.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.895.0/index.min.mjs": "sha384-mAPSf8kwmTnVH8fGCDBCZl2e3ihUI9Nrdue4h4PGL5wC93r5MaTUpSLE29ZIpPDh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.895.0/LICENSE
```

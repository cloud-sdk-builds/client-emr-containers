...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.309.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.309.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C47I4DQ9pNws9vR2ni4Tb75VGbIRYdYyLGJp+7Rp7SLqMVPH2IETO0LkaIe+Uk9f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.309.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.309.0/index.min.mjs": "sha384-C47I4DQ9pNws9vR2ni4Tb75VGbIRYdYyLGJp+7Rp7SLqMVPH2IETO0LkaIe+Uk9f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.309.0/LICENSE
```

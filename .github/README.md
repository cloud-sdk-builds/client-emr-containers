...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.261.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.261.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+M/9+sPm9nqStR0oBFiJ1b6PtFl7bsn6KPNMRiugWOliC8MPf3FfOwdBKE6povEV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.261.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.261.0/index.min.mjs": "sha384-+M/9+sPm9nqStR0oBFiJ1b6PtFl7bsn6KPNMRiugWOliC8MPf3FfOwdBKE6povEV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.261.0/LICENSE
```

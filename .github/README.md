...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.24.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.24.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vYkyEd3XEM2tDJibHOzfDSSIbadhPBb4Ykahh4HmodKHuWeGbd+8q32V+MkyygE9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.24.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.24.0/index.min.mjs": "sha384-vYkyEd3XEM2tDJibHOzfDSSIbadhPBb4Ykahh4HmodKHuWeGbd+8q32V+MkyygE9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.24.0/LICENSE
```

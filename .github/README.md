...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.130.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.130.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-egzkulZ0DE7s2zse7b5ILF9RgbmXwNVyjEO7/+YVN3QK53+AXRTihFINCr7Xf7kS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.130.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.130.0/index.min.mjs": "sha384-egzkulZ0DE7s2zse7b5ILF9RgbmXwNVyjEO7/+YVN3QK53+AXRTihFINCr7Xf7kS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.130.0/LICENSE
```

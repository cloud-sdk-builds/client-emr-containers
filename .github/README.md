...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.750.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.750.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-U88+aNjfK9RfDZPrlgXx/zltOrRwA8jWBm0QqDXV5zW9kdeFftWFlKoeEaeefr5d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.750.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.750.0/index.min.mjs": "sha384-U88+aNjfK9RfDZPrlgXx/zltOrRwA8jWBm0QqDXV5zW9kdeFftWFlKoeEaeefr5d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.750.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.4.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.4.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JtdTOM+kehmw2Mwk/iWO2Hx0du1i2BFMAmlbElcQDCU1FxU9qYEMOarmMzw+nV2a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.4.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.4.0/index.min.mjs": "sha384-JtdTOM+kehmw2Mwk/iWO2Hx0du1i2BFMAmlbElcQDCU1FxU9qYEMOarmMzw+nV2a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.4.0/LICENSE
```

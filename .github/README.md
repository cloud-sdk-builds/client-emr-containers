...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.379.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.379.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-1lXXvRGwN2oBJ9FbthV2FY72bu2FEqYr+Bx/6nmc3HEIEpVmVH7ak/FkeQCEJrtR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.379.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.379.1/index.min.mjs": "sha384-1lXXvRGwN2oBJ9FbthV2FY72bu2FEqYr+Bx/6nmc3HEIEpVmVH7ak/FkeQCEJrtR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.379.1/LICENSE
```

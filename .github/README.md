...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.481.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.481.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FG3BXlU3wLGa2NBEYauUe9ufTcvkJStsu/vmxZAvwEi55Jot7pxLhfTtvWv6YAWB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.481.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.481.0/index.min.mjs": "sha384-FG3BXlU3wLGa2NBEYauUe9ufTcvkJStsu/vmxZAvwEi55Jot7pxLhfTtvWv6YAWB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.481.0/LICENSE
```

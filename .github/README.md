...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.38.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.38.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0V4rBD68ZqtmegklTZRU/L0xTlrRXm+6CRF6eSpKZe+bno9UqNoHqW/tKCzcuBsm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.38.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.38.0/index.min.mjs": "sha384-0V4rBD68ZqtmegklTZRU/L0xTlrRXm+6CRF6eSpKZe+bno9UqNoHqW/tKCzcuBsm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.38.0/LICENSE
```

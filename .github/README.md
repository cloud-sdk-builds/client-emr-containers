...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.297.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.297.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S2DjwtlFt3FQkFwfvA07uTxMiVWjEUglnBvdDiG1S+iOiMXoq+Q8v9+xymDl4kEM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.297.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.297.0/index.min.mjs": "sha384-S2DjwtlFt3FQkFwfvA07uTxMiVWjEUglnBvdDiG1S+iOiMXoq+Q8v9+xymDl4kEM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.297.0/LICENSE
```

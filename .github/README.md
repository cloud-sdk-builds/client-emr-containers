...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j9ZMihM9LMCjYd6rsNoHAco3vp3XJ9qZnit0BCz30Uy6kTOGAk0PrN53pwGEpoIy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.996.0/index.min.mjs": "sha384-j9ZMihM9LMCjYd6rsNoHAco3vp3XJ9qZnit0BCz30Uy6kTOGAk0PrN53pwGEpoIy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.996.0/LICENSE
```

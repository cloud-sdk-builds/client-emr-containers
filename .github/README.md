...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.160.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.160.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ChU+CNeX5V7LS/eabkvWbrMfinA7rv2WNJZVG5A5QklGm6jl9n1yPrEFzPi8XRV3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.160.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.160.0/index.min.mjs": "sha384-ChU+CNeX5V7LS/eabkvWbrMfinA7rv2WNJZVG5A5QklGm6jl9n1yPrEFzPi8XRV3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.160.0/LICENSE
```

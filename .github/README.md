...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.329.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.329.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Umb3jtK4XU9gelY2hKVPbJHqigaTUbBcMWRUE3FaxzL0AtqeyXSU0LFCJfoTNWPl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.329.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.329.0/index.min.mjs": "sha384-Umb3jtK4XU9gelY2hKVPbJHqigaTUbBcMWRUE3FaxzL0AtqeyXSU0LFCJfoTNWPl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.329.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.235.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.235.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o9t5DZ3py9MFHoNr6dKSgpN22nwrj9CSO/3z9jNhG+R262ZqauJjA8La6nl63usx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.235.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.235.0/index.min.mjs": "sha384-o9t5DZ3py9MFHoNr6dKSgpN22nwrj9CSO/3z9jNhG+R262ZqauJjA8La6nl63usx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.235.0/LICENSE
```

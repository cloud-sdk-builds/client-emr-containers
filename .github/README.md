...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.606.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.606.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k4ndei3zIW5XGNZXZps7+nw4diOb4JGnJ7rNxawyVp5RXfm8bD47p9yTTwcoSKPv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.606.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.606.0/index.min.mjs": "sha384-k4ndei3zIW5XGNZXZps7+nw4diOb4JGnJ7rNxawyVp5RXfm8bD47p9yTTwcoSKPv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.606.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EQPTHVg9xMIjSENvju4tKpvvd1CIcUD/El9sTtmXlFpzJBl9xuxzsERQzLHWfLXW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.25.0/index.min.mjs": "sha384-EQPTHVg9xMIjSENvju4tKpvvd1CIcUD/El9sTtmXlFpzJBl9xuxzsERQzLHWfLXW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.25.0/LICENSE
```

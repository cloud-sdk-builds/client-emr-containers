...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.76.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.76.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L9O3KMl2NmqAWZL5GKaghyMWjz9qXokix072aJj3nwJ0dTGIWYKIvqCqEaWNEpfe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.76.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.76.0/index.min.mjs": "sha384-L9O3KMl2NmqAWZL5GKaghyMWjz9qXokix072aJj3nwJ0dTGIWYKIvqCqEaWNEpfe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.76.0/LICENSE
```

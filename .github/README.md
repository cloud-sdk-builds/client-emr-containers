...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.623.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.623.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oywnAFrK/ZPr/B2b+G80zJNjN/9VqmTbq3t6eRBTHzgCcfEkyti5JT9EcPqq0mC0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.623.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.623.0/index.min.mjs": "sha384-oywnAFrK/ZPr/B2b+G80zJNjN/9VqmTbq3t6eRBTHzgCcfEkyti5JT9EcPqq0mC0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.623.0/LICENSE
```

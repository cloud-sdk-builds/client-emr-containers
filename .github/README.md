...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.810.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.810.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SHNohBooGFZiUaXXMdJcaSgkDh/9el8RcaErHmuCT9+EBHuRBAvG8VYgOC6UnILC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.810.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.810.0/index.min.mjs": "sha384-SHNohBooGFZiUaXXMdJcaSgkDh/9el8RcaErHmuCT9+EBHuRBAvG8VYgOC6UnILC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.810.0/LICENSE
```

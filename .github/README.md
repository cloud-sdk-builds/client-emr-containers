...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-U9JXtR1QgV9Uryr3d6pSZ4CcxbWb+GP+P6vffnPPQm61Y4Qif6axpmJJ8kyfdYlt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.726.0/index.min.mjs": "sha384-U9JXtR1QgV9Uryr3d6pSZ4CcxbWb+GP+P6vffnPPQm61Y4Qif6axpmJJ8kyfdYlt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.726.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.18.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.18.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Tt1udGep/z7jLJ1FJcJI/rVatOZGCa7hho1QieHO7Jc3QURQc6KSu9vI6HzukJ99
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.18.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.18.0/index.min.mjs": "sha384-Tt1udGep/z7jLJ1FJcJI/rVatOZGCa7hho1QieHO7Jc3QURQc6KSu9vI6HzukJ99"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.18.0/LICENSE
```

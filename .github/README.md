...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.731.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.731.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RrhSz7IGyURIl6k1gvPNzuhhUbPuVw9zfQvU6DSSaltLIy/jaUy2LLHEcrOx/eBJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.731.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.731.0/index.min.mjs": "sha384-RrhSz7IGyURIl6k1gvPNzuhhUbPuVw9zfQvU6DSSaltLIy/jaUy2LLHEcrOx/eBJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.731.0/LICENSE
```

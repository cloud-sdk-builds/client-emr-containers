...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.306.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.306.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FHxzG3PNuHPQP95lrJicAh+Q9LXJ06lcJg1nQQkTepYNvdpOOfiiTMhlwWK2yHfd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.306.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.306.0/index.min.mjs": "sha384-FHxzG3PNuHPQP95lrJicAh+Q9LXJ06lcJg1nQQkTepYNvdpOOfiiTMhlwWK2yHfd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.306.0/LICENSE
```

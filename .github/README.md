...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.377.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.377.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/ojnaDn2vGgjP4wg2ixjs9kf2UxRy7ogNZAse8PMXGRnGHxj8uW8O+R9ThTuFlOI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.377.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.377.0/index.min.mjs": "sha384-/ojnaDn2vGgjP4wg2ixjs9kf2UxRy7ogNZAse8PMXGRnGHxj8uW8O+R9ThTuFlOI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.377.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.730.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.730.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dP5k7BclkLnD4D/fkIL52safjY938e+L0n3o+qw5vdoS9ZYqIAMIkFrA/JlQiSGG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.730.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.730.0/index.min.mjs": "sha384-dP5k7BclkLnD4D/fkIL52safjY938e+L0n3o+qw5vdoS9ZYqIAMIkFrA/JlQiSGG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.730.0/LICENSE
```

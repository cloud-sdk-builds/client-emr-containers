...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hHS2bNFoy1PJk67R4RNJV+XTsClYZ1LneYr+dD1TIa3EJa4bkNnciEYruBiWxEOE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.388.0/index.min.mjs": "sha384-hHS2bNFoy1PJk67R4RNJV+XTsClYZ1LneYr+dD1TIa3EJa4bkNnciEYruBiWxEOE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.388.0/LICENSE
```

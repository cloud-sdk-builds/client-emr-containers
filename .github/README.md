...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lS/4L3cQgpGfeYIji0pyItDqrhKXOknbX5wKGa0SCuZ9+h7eeL4ArGpv479JWhpq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.552.0/index.min.mjs": "sha384-lS/4L3cQgpGfeYIji0pyItDqrhKXOknbX5wKGa0SCuZ9+h7eeL4ArGpv479JWhpq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.552.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.449.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.449.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C3XIEDQb+enpz7qEzClyS42iQ+KboBUQQXtrhxPmaoivotfqN2+zYmSKWAooNuA7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.449.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.449.0/index.min.mjs": "sha384-C3XIEDQb+enpz7qEzClyS42iQ+KboBUQQXtrhxPmaoivotfqN2+zYmSKWAooNuA7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.449.0/LICENSE
```

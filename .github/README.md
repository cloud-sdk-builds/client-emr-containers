...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.231.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.231.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p3kx0OTpIDKrGK3ffkp6FU3M9CfuGQ5HsLg/DccixKdAPjZJJaMmkmfTlVY/VvzG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.231.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.231.0/index.min.mjs": "sha384-p3kx0OTpIDKrGK3ffkp6FU3M9CfuGQ5HsLg/DccixKdAPjZJJaMmkmfTlVY/VvzG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.231.0/LICENSE
```

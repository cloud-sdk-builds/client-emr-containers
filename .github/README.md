...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UY4xbQeZOIBJNoVQlXltX23mzGfqiPnGU45dpnNpi/SAYorpnbJ25hJojKEfota9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.131.0/index.min.mjs": "sha384-UY4xbQeZOIBJNoVQlXltX23mzGfqiPnGU45dpnNpi/SAYorpnbJ25hJojKEfota9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.131.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6xhoUSji0wISV7SV2YcVtV87rcQ7ybTcQ67BrAHuZ7Plbns3j9nGBEWGKg8UyXnI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.975.0/index.min.mjs": "sha384-6xhoUSji0wISV7SV2YcVtV87rcQ7ybTcQ67BrAHuZ7Plbns3j9nGBEWGKg8UyXnI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.975.0/LICENSE
```

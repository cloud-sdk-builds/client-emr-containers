...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.32.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.32.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EOk5txGcWfGnlAICqhvId4m1dw4FwmXOFD5zfndKHgB6DSfUN2OKJ+h3+oEPGNuk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.32.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.32.0/index.min.mjs": "sha384-EOk5txGcWfGnlAICqhvId4m1dw4FwmXOFD5zfndKHgB6DSfUN2OKJ+h3+oEPGNuk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.32.0/LICENSE
```

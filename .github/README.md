...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.186.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.186.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lPLUwv5wrokhHobr8dUWD7i2weAdT+6YIkvlZ4mVUyeH8UmQh7MGojNqAR2ELeO5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.186.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.186.0/index.min.mjs": "sha384-lPLUwv5wrokhHobr8dUWD7i2weAdT+6YIkvlZ4mVUyeH8UmQh7MGojNqAR2ELeO5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.186.0/LICENSE
```

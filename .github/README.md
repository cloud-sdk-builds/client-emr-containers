...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.23.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.23.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mf73jeIL1qDk8ctoX9l/Z5MD7I1NttADymY6jevef2wxiTSMgtiokH+oY3HOiVIa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.23.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.23.0/index.min.mjs": "sha384-mf73jeIL1qDk8ctoX9l/Z5MD7I1NttADymY6jevef2wxiTSMgtiokH+oY3HOiVIa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.23.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.128.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m3B80W63lOHgCBSQA2b621Hk3YN7dLyuaRvp18b7kuAXWqx2rh+yGbKKv6z2U+qB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.128.0/index.min.mjs": "sha384-m3B80W63lOHgCBSQA2b621Hk3YN7dLyuaRvp18b7kuAXWqx2rh+yGbKKv6z2U+qB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.128.0/LICENSE
```

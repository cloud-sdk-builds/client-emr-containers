...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1018.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1018.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/FQrWP9bT38HGKNSwALZ/srC2FxeF7R/96n3UMuHXtv+FAqcDcpQkZ5VwsGfFmsZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1018.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1018.0/index.min.mjs": "sha384-/FQrWP9bT38HGKNSwALZ/srC2FxeF7R/96n3UMuHXtv+FAqcDcpQkZ5VwsGfFmsZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1018.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.370.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.370.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LCsM5FmX9MSdzSNQ+XQ6EhiP3W1gM+k34XcY/yeBP/G+5HcUEozMXCtWCi0oPX8Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.370.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.370.0/index.min.mjs": "sha384-LCsM5FmX9MSdzSNQ+XQ6EhiP3W1gM+k34XcY/yeBP/G+5HcUEozMXCtWCi0oPX8Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.370.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.99.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.99.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GbmeoSCJ/axUoksfR1otwf+nLQOXRlwWLO6h0FgLl/oIJNNoVndsa0AFEOjBxm86
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.99.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.99.0/index.min.mjs": "sha384-GbmeoSCJ/axUoksfR1otwf+nLQOXRlwWLO6h0FgLl/oIJNNoVndsa0AFEOjBxm86"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.99.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.81.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.81.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jn57WL3cg+8uCNwmXS6CFjfZTHFkWQWWHyL6+yakI66pZpSlH2NIUYvvwVWilUTl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.81.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.81.0/index.min.mjs": "sha384-jn57WL3cg+8uCNwmXS6CFjfZTHFkWQWWHyL6+yakI66pZpSlH2NIUYvvwVWilUTl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.81.0/LICENSE
```

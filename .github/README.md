...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LLe5411LkAyeEdzr9jCh3Ku7tzk46MINs6aNfK9I4suAuJaLMmDOeNrkj+I/H2hK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.290.0/index.min.mjs": "sha384-LLe5411LkAyeEdzr9jCh3Ku7tzk46MINs6aNfK9I4suAuJaLMmDOeNrkj+I/H2hK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.290.0/LICENSE
```

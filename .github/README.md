...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.46.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.46.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CGhrg2FCfq8mMyQzFbpQTc/1Pc+snH5xy9HPd5TZRsxYxjL2CPF6+UlTyQKWho6e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.46.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.46.0/index.min.mjs": "sha384-CGhrg2FCfq8mMyQzFbpQTc/1Pc+snH5xy9HPd5TZRsxYxjL2CPF6+UlTyQKWho6e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.46.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.930.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.930.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oL/TCXp2ZshKNzaUKF2/FHqZVDWvX8TVY7sB7Kq6Ska1Eld7zCFf1poaq9iopaJT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.930.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.930.0/index.min.mjs": "sha384-oL/TCXp2ZshKNzaUKF2/FHqZVDWvX8TVY7sB7Kq6Ska1Eld7zCFf1poaq9iopaJT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.930.0/LICENSE
```

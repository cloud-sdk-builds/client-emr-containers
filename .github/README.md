...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.682.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.682.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IKm/uBvUZw5Riu8NfzcGFR/xWJqKFozNb6BebtS0GWfd+SuX/u4WhAz81oaHAV+p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.682.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.682.0/index.min.mjs": "sha384-IKm/uBvUZw5Riu8NfzcGFR/xWJqKFozNb6BebtS0GWfd+SuX/u4WhAz81oaHAV+p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.682.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.218.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.218.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AHuzxmG7dIK5+pzpoMYz1TYIjJJaMO+JEC+WV5V3j8FPQQPGs7N2TDif2pk+g2ik
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.218.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.218.0/index.min.mjs": "sha384-AHuzxmG7dIK5+pzpoMYz1TYIjJJaMO+JEC+WV5V3j8FPQQPGs7N2TDif2pk+g2ik"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.218.0/LICENSE
```

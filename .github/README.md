...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.474.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.474.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lEc0Cd05hvUZeKlyL2voHHz5MWYly0pQweadZtkA03Mxbo0wbDVtCElyBnfkh+hS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.474.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.474.0/index.min.mjs": "sha384-lEc0Cd05hvUZeKlyL2voHHz5MWYly0pQweadZtkA03Mxbo0wbDVtCElyBnfkh+hS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.474.0/LICENSE
```

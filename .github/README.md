...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.39.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.39.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xuhd3oi5unMONaL3akLHN7mBeALmYSnh2QozYg1RCKNpFFioaZEBmaMJiwWS7bGT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.39.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.39.0/index.min.mjs": "sha384-Xuhd3oi5unMONaL3akLHN7mBeALmYSnh2QozYg1RCKNpFFioaZEBmaMJiwWS7bGT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.39.0/LICENSE
```

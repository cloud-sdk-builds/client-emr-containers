...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.141.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.141.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ABLxAzurvNusSeXz70zPGk7quzjkYN1XpnMtGbs6ruh/X6KkEf5OiVAPbdHXaKqL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.141.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.141.0/index.min.mjs": "sha384-ABLxAzurvNusSeXz70zPGk7quzjkYN1XpnMtGbs6ruh/X6KkEf5OiVAPbdHXaKqL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.141.0/LICENSE
```

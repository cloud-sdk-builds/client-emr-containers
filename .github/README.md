...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.470.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.470.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QDwiFuxe00kV34JW5TvXiyXq0i3INHefyfKZJD47WT2q4INuOROhpF1hcXLIKo84
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.470.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.470.0/index.min.mjs": "sha384-QDwiFuxe00kV34JW5TvXiyXq0i3INHefyfKZJD47WT2q4INuOROhpF1hcXLIKo84"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.470.0/LICENSE
```

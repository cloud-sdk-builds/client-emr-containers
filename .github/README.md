...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.533.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.533.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ki/351UuoJ4aCvkwdByeoGtTFhFb2bspct+p37lAJ4PcPmHZT8rP+55FfFxHBQOH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.533.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.533.0/index.min.mjs": "sha384-Ki/351UuoJ4aCvkwdByeoGtTFhFb2bspct+p37lAJ4PcPmHZT8rP+55FfFxHBQOH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.533.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.245.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.245.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RemibafKxrrzRX7mgPP+04mpZs/O5U7RcZDjdkbaxPlBgZCe371FMX9U0d0dK/Uk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.245.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.245.0/index.min.mjs": "sha384-RemibafKxrrzRX7mgPP+04mpZs/O5U7RcZDjdkbaxPlBgZCe371FMX9U0d0dK/Uk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.245.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-s1RPr+nlNqvhHHbVHalKiOjFWnzQlqPu2WoY1BOCrqmsB71o23GZl8uGlcipewao
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.118.1/index.min.mjs": "sha384-s1RPr+nlNqvhHHbVHalKiOjFWnzQlqPu2WoY1BOCrqmsB71o23GZl8uGlcipewao"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.118.1/LICENSE
```

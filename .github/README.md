...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.907.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.907.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/s+EABbSlH+tQM/QAvY9/zGviwJoI63pwUUCJ8VG2ehNrxrByJyDLUmdj5m+pkTv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.907.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.907.0/index.min.mjs": "sha384-/s+EABbSlH+tQM/QAvY9/zGviwJoI63pwUUCJ8VG2ehNrxrByJyDLUmdj5m+pkTv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.907.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.632.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.632.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0/6TVFEloBzvR2jltANoxGlBWZbb5UNOrb5CuKIvebxhRMJTWw3pBe3RswNiSPHS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.632.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.632.0/index.min.mjs": "sha384-0/6TVFEloBzvR2jltANoxGlBWZbb5UNOrb5CuKIvebxhRMJTWw3pBe3RswNiSPHS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.632.0/LICENSE
```

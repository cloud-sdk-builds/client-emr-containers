...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.282.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.282.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qe6XJ7Z6WKkl+QkG57du5Sbt1R3MZ1jNF2IDGBu/3WrhZTjw9GbofAUNRJmIx8HD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.282.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.282.0/index.min.mjs": "sha384-Qe6XJ7Z6WKkl+QkG57du5Sbt1R3MZ1jNF2IDGBu/3WrhZTjw9GbofAUNRJmIx8HD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.282.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.414.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.414.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+UjxIZFC7wEfU2hmTQsOfQRmP/h+3sfDiPp9hAQz2SQFUoRnCbIpMd8B8Gect3id
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.414.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.414.0/index.min.mjs": "sha384-+UjxIZFC7wEfU2hmTQsOfQRmP/h+3sfDiPp9hAQz2SQFUoRnCbIpMd8B8Gect3id"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.414.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.266.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.266.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-/lJ7s5SGJOjEUY3GWiPC1Ov6iF302yJf//4gtUqJicn6pn6RV6sQGD6Ul1wGkmD5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.266.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.266.1/index.min.mjs": "sha384-/lJ7s5SGJOjEUY3GWiPC1Ov6iF302yJf//4gtUqJicn6pn6RV6sQGD6Ul1wGkmD5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.266.1/LICENSE
```

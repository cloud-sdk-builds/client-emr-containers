...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.565.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.565.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dKN6ZpAKiBYjdx4GoAZCGMS/bCC6y2P/QQlniV8exFddGutJN+1RUe0lKD2FEZKW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.565.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.565.0/index.min.mjs": "sha384-dKN6ZpAKiBYjdx4GoAZCGMS/bCC6y2P/QQlniV8exFddGutJN+1RUe0lKD2FEZKW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.565.0/LICENSE
```

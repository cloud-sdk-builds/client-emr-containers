...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.962.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.962.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ewjnsj7p49RppoLi6Zxrnhy7hFJK/r6tSNQodiHyS3umH2hF+l73ZSdtF8oDrNgU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.962.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.962.0/index.min.mjs": "sha384-Ewjnsj7p49RppoLi6Zxrnhy7hFJK/r6tSNQodiHyS3umH2hF+l73ZSdtF8oDrNgU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.962.0/LICENSE
```

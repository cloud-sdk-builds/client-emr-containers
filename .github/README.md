...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.992.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.992.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WCyUlVvUejubpP4RCVxuZSR3Pkt6PQ5nzhvCgY9KoV87KEhg6zsggT3fm0rw1aIv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.992.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.992.0/index.min.mjs": "sha384-WCyUlVvUejubpP4RCVxuZSR3Pkt6PQ5nzhvCgY9KoV87KEhg6zsggT3fm0rw1aIv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.992.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g8QoO8i91AC/TNozFn8xg+Re3Ept0O4za2ngaFKMax1S+oXzxmXpMoTO942DQdVZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.913.0/index.min.mjs": "sha384-g8QoO8i91AC/TNozFn8xg+Re3Ept0O4za2ngaFKMax1S+oXzxmXpMoTO942DQdVZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.913.0/LICENSE
```

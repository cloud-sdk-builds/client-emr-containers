...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.74.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.74.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a3cR6BnlvFsW/XWBmKOan4V1O9c/MpA0dVjkCQwA0wKYQGXhtlFJF5dfZW1Dk5Ap
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.74.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.74.0/index.min.mjs": "sha384-a3cR6BnlvFsW/XWBmKOan4V1O9c/MpA0dVjkCQwA0wKYQGXhtlFJF5dfZW1Dk5Ap"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.74.0/LICENSE
```

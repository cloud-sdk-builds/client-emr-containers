...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.109.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.109.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qtXQAYrKkbZScAb3+1ADmneh3frB1cu5tSkPRUmRuHx0z6VJNOlrmIB6KNI94zhi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.109.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.109.0/index.min.mjs": "sha384-qtXQAYrKkbZScAb3+1ADmneh3frB1cu5tSkPRUmRuHx0z6VJNOlrmIB6KNI94zhi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.109.0/LICENSE
```

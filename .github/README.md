...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.562.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.562.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s89J+SpIZJcy7FdPQrvD5pU69+7RDj0k9x8kVtoyxBXpsqCbXzDA6ZoAkELRNCQn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.562.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.562.0/index.min.mjs": "sha384-s89J+SpIZJcy7FdPQrvD5pU69+7RDj0k9x8kVtoyxBXpsqCbXzDA6ZoAkELRNCQn"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.562.0`)
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.562.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PWxafM8Ew078XfIBU9uFPWm1yInqYutck4JhpdtF05RS/P5xLBSf9hbsHvqOF5Cm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.667.0/index.min.mjs": "sha384-PWxafM8Ew078XfIBU9uFPWm1yInqYutck4JhpdtF05RS/P5xLBSf9hbsHvqOF5Cm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.667.0/LICENSE
```

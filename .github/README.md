...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.78.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.78.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uHjdHetFP39QR6bVdfbAp2gsKwMDh/fFeIs9vcbUq2Cv9sQFPRAiUaapQp1zYJEd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.78.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.78.0/index.min.mjs": "sha384-uHjdHetFP39QR6bVdfbAp2gsKwMDh/fFeIs9vcbUq2Cv9sQFPRAiUaapQp1zYJEd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.78.0/LICENSE
```

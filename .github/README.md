...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.716.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.716.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4/ZEreRGMmCQQ6OlqDcbCTcsJaVsYIAf4lNk1C2cTK5gzrc6iCqeaDvJu8Qi3dYq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.716.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.716.0/index.min.mjs": "sha384-4/ZEreRGMmCQQ6OlqDcbCTcsJaVsYIAf4lNk1C2cTK5gzrc6iCqeaDvJu8Qi3dYq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.716.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.259.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.259.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Vs4C1m9JhlTM04/Ey3hGFfoMwB2ALD+j5OXAuS1yA31gbJNRQi9sm5NmdFxgSSZs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.259.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.259.0/index.min.mjs": "sha384-Vs4C1m9JhlTM04/Ey3hGFfoMwB2ALD+j5OXAuS1yA31gbJNRQi9sm5NmdFxgSSZs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.259.0/LICENSE
```

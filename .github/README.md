...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.169.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.169.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M98FTZukbZvkNARZafxqs9nKYvzwn/fk0vq4Wmbh5x4rDJyh9MH3KdlCDIfkSWF/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.169.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.169.0/index.min.mjs": "sha384-M98FTZukbZvkNARZafxqs9nKYvzwn/fk0vq4Wmbh5x4rDJyh9MH3KdlCDIfkSWF/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.169.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.301.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.301.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4/pT8GvMBFL1zE1q4/jHICwIY+l3OkIIo5xeqid+4/19+iAm7ynYxZ1B8wyM+rd4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.301.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.301.0/index.min.mjs": "sha384-4/pT8GvMBFL1zE1q4/jHICwIY+l3OkIIo5xeqid+4/19+iAm7ynYxZ1B8wyM+rd4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.301.0/LICENSE
```

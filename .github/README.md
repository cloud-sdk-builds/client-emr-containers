...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.34.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.34.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+CwgW7n7mCUoNfwFPpOMA8sgRkOcQKFa0OeeReDnSP29QY4OHTfetCDtbS9Btf50
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.34.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.34.0/index.min.mjs": "sha384-+CwgW7n7mCUoNfwFPpOMA8sgRkOcQKFa0OeeReDnSP29QY4OHTfetCDtbS9Btf50"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.34.0/LICENSE
```

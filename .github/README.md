...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.693.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.693.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aKP2c1KCEcO6+QBK2hwOIcg0+dwub5C33DsyVPakFLKNGCmeQ241OOrvY3Yio485
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.693.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.693.0/index.min.mjs": "sha384-aKP2c1KCEcO6+QBK2hwOIcg0+dwub5C33DsyVPakFLKNGCmeQ241OOrvY3Yio485"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.693.0/LICENSE
```

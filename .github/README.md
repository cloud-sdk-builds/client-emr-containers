...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.321.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.321.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-FiQpKS9a4xf9uCxV5c1EB6PFnYKsnVycRgQrun3iQ7LYVZcqCWt6mqlMrDEJYSlB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.321.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.321.1/index.min.mjs": "sha384-FiQpKS9a4xf9uCxV5c1EB6PFnYKsnVycRgQrun3iQ7LYVZcqCWt6mqlMrDEJYSlB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.321.1/LICENSE
```

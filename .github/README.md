...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.0.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.0.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LQHSPYu8eyuYgbgIhxMNSNqKcwXyR1/Ag3A/Wi9TJNY6EVQXXydFtHVrU1RgTWXz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.0.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.0.0/index.min.mjs": "sha384-LQHSPYu8eyuYgbgIhxMNSNqKcwXyR1/Ag3A/Wi9TJNY6EVQXXydFtHVrU1RgTWXz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.0.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.501.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.501.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XVvOQeQwsTRJ8TYJ2H26zU5L7CcaymSYbf3rhXoh3JyZJjkVY2gePqpmKT0nWvf8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.501.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.501.0/index.min.mjs": "sha384-XVvOQeQwsTRJ8TYJ2H26zU5L7CcaymSYbf3rhXoh3JyZJjkVY2gePqpmKT0nWvf8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.501.0/LICENSE
```

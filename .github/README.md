...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aIywc9TUuXUcRIxsopEP6iXgkYF+tJd0OrOMC1GN1OnzA5rlf1JcgnG/SxhXJHnX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.978.0/index.min.mjs": "sha384-aIywc9TUuXUcRIxsopEP6iXgkYF+tJd0OrOMC1GN1OnzA5rlf1JcgnG/SxhXJHnX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.978.0/LICENSE
```

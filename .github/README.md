...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.872.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.872.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V3BNI5uXbXame3Tn9rXQ8jJ5Y/PJyr/MBK9Na26alL/FaHUafSa4LzUqJo9NXPEL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.872.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.872.0/index.min.mjs": "sha384-V3BNI5uXbXame3Tn9rXQ8jJ5Y/PJyr/MBK9Na26alL/FaHUafSa4LzUqJo9NXPEL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.872.0/LICENSE
```

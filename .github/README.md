...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.513.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.513.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yGmC4TXAyz9rud0YlVzvh0uMEV1rOUUQmkyJMBx1oKb3W8YPiCZunwgHiwSt+COy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.513.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.513.0/index.min.mjs": "sha384-yGmC4TXAyz9rud0YlVzvh0uMEV1rOUUQmkyJMBx1oKb3W8YPiCZunwgHiwSt+COy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.513.0/LICENSE
```

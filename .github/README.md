...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.583.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.583.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i8N6HRIpD9zXXSbaThhhUGRGjTIlz6LeEz+AEoaP32Row0da9wLj5YN2mJh6LmMw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.583.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.583.0/index.min.mjs": "sha384-i8N6HRIpD9zXXSbaThhhUGRGjTIlz6LeEz+AEoaP32Row0da9wLj5YN2mJh6LmMw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.583.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.651.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.651.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-jCBHWVQlE6++xd87XSpmzCH4BfxqG6Kq65x60o/Kj/27Tt80oNCjQNVAcYTZNTcq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.651.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.651.1/index.min.mjs": "sha384-jCBHWVQlE6++xd87XSpmzCH4BfxqG6Kq65x60o/Kj/27Tt80oNCjQNVAcYTZNTcq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.651.1/LICENSE
```

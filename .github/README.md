...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.679.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xBMVAZMwBkGq8r28s0Q+Z/9hHg+Aa+X4mvKom/rNLTU/u+0tJQ0Ehx5Zu0nuUkRy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.679.0/index.min.mjs": "sha384-xBMVAZMwBkGq8r28s0Q+Z/9hHg+Aa+X4mvKom/rNLTU/u+0tJQ0Ehx5Zu0nuUkRy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.679.0/LICENSE
```

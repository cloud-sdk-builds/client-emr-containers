...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.696.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.696.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8YTNf62sS2BxZJz9EKvXzQXMRsMrYYI8+6PqAMpWvZdeWD5Bthwgwkglu8DU1+UQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.696.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.696.0/index.min.mjs": "sha384-8YTNf62sS2BxZJz9EKvXzQXMRsMrYYI8+6PqAMpWvZdeWD5Bthwgwkglu8DU1+UQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.696.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.268.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.268.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UafneTe/QDSq1iG3+uXJ+MNOM/4DpPyyz8tb4wfPJ/nE/FWz+VTCgJ354Qnd7BlU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.268.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.268.0/index.min.mjs": "sha384-UafneTe/QDSq1iG3+uXJ+MNOM/4DpPyyz8tb4wfPJ/nE/FWz+VTCgJ354Qnd7BlU"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.268.0`)
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.268.0/LICENSE
```

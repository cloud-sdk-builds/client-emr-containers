...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.927.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.927.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KWplwiB1HEYw7V7fnWjQ+X16o9DQlt2/WryaXeZKWKk27ZKg7yVOqJnDBFjz50It
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.927.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.927.0/index.min.mjs": "sha384-KWplwiB1HEYw7V7fnWjQ+X16o9DQlt2/WryaXeZKWKk27ZKg7yVOqJnDBFjz50It"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.927.0/LICENSE
```

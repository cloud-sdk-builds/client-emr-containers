...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.675.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.675.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8TmkfVjcijJPEXtT56QIa7+N9VpmXpy6gzdARCtQaw3vZnKFw8Nv7JvxNcDvcoY0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.675.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.675.0/index.min.mjs": "sha384-8TmkfVjcijJPEXtT56QIa7+N9VpmXpy6gzdARCtQaw3vZnKFw8Nv7JvxNcDvcoY0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.675.0/LICENSE
```

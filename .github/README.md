...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.56.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.56.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I9msVFza+b28nfEkoCmoLBUWdEU8zdWVrQ/IL2mG23iLdBZyagGlmMTWC01paN8r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.56.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.56.0/index.min.mjs": "sha384-I9msVFza+b28nfEkoCmoLBUWdEU8zdWVrQ/IL2mG23iLdBZyagGlmMTWC01paN8r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.56.0/LICENSE
```

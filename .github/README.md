...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.1039.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1039.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O6Yf7h5VNgiWflmlKahOrS3sQjJPZDIwJyqwFtKMzUEL8meZzPh1pGKxSCAv/GgM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1039.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.1039.0/index.min.mjs": "sha384-O6Yf7h5VNgiWflmlKahOrS3sQjJPZDIwJyqwFtKMzUEL8meZzPh1pGKxSCAv/GgM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.1039.0/LICENSE
```

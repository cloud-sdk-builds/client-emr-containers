...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.845.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.845.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-48T4a8wRXXtz/LlMZP2IKr1hbsJjIvrSQAxYNL5V4q9ZR1rTs9lvFovpDK2Nkxjj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.845.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.845.0/index.min.mjs": "sha384-48T4a8wRXXtz/LlMZP2IKr1hbsJjIvrSQAxYNL5V4q9ZR1rTs9lvFovpDK2Nkxjj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.845.0/LICENSE
```

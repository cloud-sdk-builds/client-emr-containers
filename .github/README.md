...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s0i8W+/TfYfYGeT42hfZRq1brfISEm/qMcV2kjvZ06bsAYUjiGAiNlhWwb4hkp9a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.798.0/index.min.mjs": "sha384-s0i8W+/TfYfYGeT42hfZRq1brfISEm/qMcV2kjvZ06bsAYUjiGAiNlhWwb4hkp9a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.798.0/LICENSE
```

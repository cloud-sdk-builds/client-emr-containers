...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dFE86Q8FguaHuswfmuVmH8ocoi/yWNIMgchGm/EIP8eZyP0KLqk2fP6SdlbYBQiI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.264.0/index.min.mjs": "sha384-dFE86Q8FguaHuswfmuVmH8ocoi/yWNIMgchGm/EIP8eZyP0KLqk2fP6SdlbYBQiI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.264.0/LICENSE
```

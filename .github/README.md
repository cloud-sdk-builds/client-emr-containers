...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.362.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.362.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V+X5ljh9/rgOc2DHpXb2WHQTIBFwsx6wQdS3ojRtBDdL4A+GhDhMAUg5mqZh+Jo0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.362.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.362.0/index.min.mjs": "sha384-V+X5ljh9/rgOc2DHpXb2WHQTIBFwsx6wQdS3ojRtBDdL4A+GhDhMAUg5mqZh+Jo0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.362.0/LICENSE
```

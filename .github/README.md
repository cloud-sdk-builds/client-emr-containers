...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jmibBObcS1egN/JaBB0aBFmYOPgkIJvM/CBC8c4FXRkw234cCg++iafva8RX666x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.882.0/index.min.mjs": "sha384-jmibBObcS1egN/JaBB0aBFmYOPgkIJvM/CBC8c4FXRkw234cCg++iafva8RX666x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.882.0/LICENSE
```

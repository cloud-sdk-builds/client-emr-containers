...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.445.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.445.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2RLj/g3Vw1aZ8Bao/mnrNi4OytcKCK2ylbk45rndJo/wM15oSldHPTWevCv/qSLa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.445.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.445.0/index.min.mjs": "sha384-2RLj/g3Vw1aZ8Bao/mnrNi4OytcKCK2ylbk45rndJo/wM15oSldHPTWevCv/qSLa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.445.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.118.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4jAMmLQc3i9yHrX7WGVovYLr+aFtceGCjXU1HfFvNUe2OxYMcOU0QZk+mf1RRFKY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.118.0/index.min.mjs": "sha384-4jAMmLQc3i9yHrX7WGVovYLr+aFtceGCjXU1HfFvNUe2OxYMcOU0QZk+mf1RRFKY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.118.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.326.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.326.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cNNWvmj/7r/tOSkiAIG0memS4AwBbLdtKsVvWUouOV7hmqo6P3VYbn3WdoXSpz7u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.326.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.326.0/index.min.mjs": "sha384-cNNWvmj/7r/tOSkiAIG0memS4AwBbLdtKsVvWUouOV7hmqo6P3VYbn3WdoXSpz7u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.326.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.826.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.826.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vXsIETowPOngY43xs5UJckJmWAD/Gd6OiYpSDProXrM5uBjGXzrXr+2pMkwmup6e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.826.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.826.0/index.min.mjs": "sha384-vXsIETowPOngY43xs5UJckJmWAD/Gd6OiYpSDProXrM5uBjGXzrXr+2pMkwmup6e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.826.0/LICENSE
```

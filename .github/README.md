...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.171.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.171.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Bjs3J6AaO9wQgemGnZLkxfJH0mBczuXUjvXjcK1ltS0SIAKDASs42WikURpfbY4R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.171.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.171.0/index.min.mjs": "sha384-Bjs3J6AaO9wQgemGnZLkxfJH0mBczuXUjvXjcK1ltS0SIAKDASs42WikURpfbY4R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.171.0/LICENSE
```

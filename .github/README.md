...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.22.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.22.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RWAjj0eU3whJN2uiZCKKtEEpJaxBZMrgLdvq2JvBWn7RPpYQnYfnrQY7ImcQpryq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.22.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.22.0/index.min.mjs": "sha384-RWAjj0eU3whJN2uiZCKKtEEpJaxBZMrgLdvq2JvBWn7RPpYQnYfnrQY7ImcQpryq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.22.0/LICENSE
```

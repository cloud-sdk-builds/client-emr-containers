...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.502.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.502.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tOXIlzR0P9cAtVU4aZtvRM/ttg6+df73IivOxVcY+2rvBYrIrpOvGc5LMI/yU1/G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.502.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.502.0/index.min.mjs": "sha384-tOXIlzR0P9cAtVU4aZtvRM/ttg6+df73IivOxVcY+2rvBYrIrpOvGc5LMI/yU1/G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.502.0/LICENSE
```

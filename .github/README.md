...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.678.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.678.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A3FUfhzq2NLGP2PzvkGZ/VGCYr/rFctpZjB9BBd39U4Su3S6AvfWp2V7Vz84qzDE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.678.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.678.0/index.min.mjs": "sha384-A3FUfhzq2NLGP2PzvkGZ/VGCYr/rFctpZjB9BBd39U4Su3S6AvfWp2V7Vz84qzDE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.678.0/LICENSE
```

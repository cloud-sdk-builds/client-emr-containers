...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.529.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.529.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-UD8MyNDWK04sha02fNtVqGYC6k3SUzjYOPOQ9N/xBVAeiM+SJn1KLL/MkHbPUKUl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.529.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.529.1/index.min.mjs": "sha384-UD8MyNDWK04sha02fNtVqGYC6k3SUzjYOPOQ9N/xBVAeiM+SJn1KLL/MkHbPUKUl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.529.1/LICENSE
```

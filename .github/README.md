...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.863.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.863.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rJEGLr3EJGN7BJGkto9yIq9Aw8zrk/+nvzYQjnJfkwM+eQariVAUzRP1iafOovM4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.863.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.863.0/index.min.mjs": "sha384-rJEGLr3EJGN7BJGkto9yIq9Aw8zrk/+nvzYQjnJfkwM+eQariVAUzRP1iafOovM4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.863.0/LICENSE
```

...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.556.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.556.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nL0HLiosNNbV4la2H9gAVA0U7HXrSIWHO3wi7NEYrM0ls9z0OhvmQwI05cku9dk1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.556.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.556.0/index.min.mjs": "sha384-nL0HLiosNNbV4la2H9gAVA0U7HXrSIWHO3wi7NEYrM0ls9z0OhvmQwI05cku9dk1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.556.0/LICENSE
```

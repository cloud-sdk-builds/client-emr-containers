...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.347.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.347.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-bkACLn4l7LlS5tuW2vPmCkNl+uUUGM+NuWKxGZ9Aqw7TK4ob4g7UAc7fTR+3NLl+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.347.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.347.1/index.min.mjs": "sha384-bkACLn4l7LlS5tuW2vPmCkNl+uUUGM+NuWKxGZ9Aqw7TK4ob4g7UAc7fTR+3NLl+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.347.1/LICENSE
```

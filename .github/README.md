...
[`@aws-sdk/client-emr-containers`](https://www.npmjs.com/package/@aws-sdk/client-emr-containers/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZkgmCu/bFIP4uFoJ/O0Y00X83XscO507ZJ+BwG2RGjzERzROgC0K8M3XMLYubDpW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-emr-containers": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-emr-containers@3.47.0/index.min.mjs": "sha384-ZkgmCu/bFIP4uFoJ/O0Y00X83XscO507ZJ+BwG2RGjzERzROgC0K8M3XMLYubDpW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-emr-containers/blob/refs/tags/3.47.0/LICENSE
```
